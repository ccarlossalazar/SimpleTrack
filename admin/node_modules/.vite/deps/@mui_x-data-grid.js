...
} from "./chunk-P2H7VOAV.js";
import "./chunk-BF2GYJQJ.js";
import "./chunk-EWNDVVE4.js";
import {
  Paper_default,
  alpha,
  darken,
  lighten,
  toPropertyKey
} from "./chunk-GI664H7J.js";
import "./chunk-KZSXMHDE.js";
import "./chunk-VXUN6V3I.js";
import "./chunk-MVOFDRCM.js";
import "./chunk-FF3KPOBC.js";
import "./chunk-RKXEIPLL.js";
import "./chunk-TIP5IBKR.js";
import "./chunk-LJXNCWBU.js";
import {
  require_react_dom
} from "./chunk-6LPEFJW3.js";
import {
  debounce_default,
  init_utils,
...
import {
  ...
  useId
} from "./chunk-HYG2W6MY.js";
import {
  capitalize_default
} from "./chunk-KC77S26S.js";
import {
  composeClasses,
  generateUtilityClasses,
  styled_default
} from "./chunk-ILGVHKJY.js";
import {
  _extends,
  ...
  require_prop_types
} from "./chunk-EDEWO4TX.js";
import {
  require_jsx_runtime
} from "./chunk-M6SP3ZXC.js";
import {
  require_react
} from "./chunk-X2UYWDEI.js";
import {
  __toESM
...
var useGridApiRef = () => React.useRef({});
...
function createDetectElementResize(nonce, hostWindow) {
  ...
  var createStyles = function createStyles2(doc, root) {
...
var GridAutoSizer = React3.forwardRef(function AutoSizer(props, ref) {
  const {
    children,
    defaultHeight = null,
    defaultWidth = null,
  ...
  const parentElement = React3.useRef(null);
  const handleResize = useEventCallback_default2(() => {
...
var gridDensityValueSelector = createSelector(gridDensitySelector, (density) => density.value);
var gridDensityRowHeightSelector = createSelector(gridDensitySelector, (density) => density.rowHeight);
var gridDensityHeaderHeightSelector = createSelector(gridDensitySelector, (density) => density.headerHeight);
var gridDensityHeaderGroupingMaxDepthSelector = createSelector(gridDensitySelector, (density) => density.headerGroupingMaxDepth);
var gridDensityFactorSelector = createSelector(gridDensitySelector, (density) => density.factor);
var gridDensityTotalHeaderHeightSelector = createSelector(gridDensitySelector, (density) => density.headerHeight * (1 + density.headerGroupingMaxDepth));
...
function GridOverlayWrapper(props) {
  ...
  const [viewportInnerSize, setViewportInnerSize] = React4.useState(() => {
    var _apiRef$current$getRo, _apiRef$current$getRo2;
    return (_apiRef$current$getRo = (_apiRef$current$getRo2 = apiRef.current.getRootDimensions()) == null ? void 0 : _apiRef$current$getRo2.viewportInnerSize) != null ? _apiRef$current$getRo : null;
  });
  const handleViewportSizeChange = React4.useCallback(() => {
...
function GridBody(props) {
  ...
  const rootProps = useGridRootProps();
  const totalHeaderHeight = useGridSelector(apiRef, gridDensityTotalHeaderHeightSelector);
  const [isVirtualizationDisabled, setIsVirtualizationDisabled] = React5.useState(rootProps.disableVirtualization);
  const disableVirtualization = React5.useCallback(() => {
    setIsVirtualizationDisabled(true);
  }, []);
  const enableVirtualization = React5.useCallback(() => {
  ...
  const columnHeadersRef = React5.useRef(null);
  const columnsContainerRef = React5.useRef(null);
  const windowRef = React5.useRef(null);
  const renderingZoneRef = React5.useRef(null);
  apiRef.current.columnHeadersContainerElementRef = columnsContainerRef;
  apiRef.current.columnHeadersElementRef = columnHeadersRef;
  apiRef.current.windowRef = windowRef;
  apiRef.current.renderingZoneRef = renderingZoneRef;
  const handleResize = React5.useCallback((size) => {
...
function useGridLogger(apiRef, name) {
  const logger = React6.useRef(null);
  if (logger.current) {
  ...
  return (0, import_jsx_runtime6.jsx)(ErrorBoundary, {
    ...
    render: (errorProps) => {
      ...
      return (0, import_jsx_runtime6.jsx)(GridMainContainer, {
        children: (0, import_jsx_runtime6.jsx)(rootProps.components.ErrorOverlay, _extends({}, errorProps, errorState, (_rootProps$components = rootProps.componentsProps) == null ? void 0 : _rootProps$components.errorOverlay))
      });
    },
    children
  });
...
function GridFooterPlaceholder() {
  ...
  const apiRef = useGridApiContext();
  const rootProps = useGridRootProps();
  const footerRef = React9.useRef(null);
...
function GridCell(props) {
  ...
  const focusElementRef = React11.useRef(null);
  const apiRef = useGridApiContext();
  const rootProps = useGridRootProps();
  const ownerState = {
    align,
  ...
  const publishMouseUp = React11.useCallback((eventName) => (event) => {
  ...
  const publishMouseDown = React11.useCallback((eventName) => (event) => {
    const params = apiRef.current.getCellParams(rowId, field || "");
    apiRef.current.publishEvent(eventName, params, event);
    if (onMouseDown) {
      onMouseDown(event);
  ...
  const publish = React11.useCallback((eventName, propHandler) => (event) => {
  ...
  const renderChildren = () => {
    ...
    if (React11.isValidElement(children) && managesOwnFocus) {
...
var _excluded3 = ["label", "icon", "showInMenu", "onClick"];
var GridActionsCellItem = React12.forwardRef((props, ref) => {
  const {
    label,
    icon,
    showInMenu,
  ...
  if (!showInMenu) {
    return (0, import_jsx_runtime10.jsx)(IconButton_default, _extends({
      ref,
      size: "small",
      role: "menuitem",
      "aria-label": label
      ...
      onClick: handleClick,
      children: React12.cloneElement(icon, {
        fontSize: "small"
      })
    }));
  }
  return (0, import_jsx_runtime11.jsxs)(MenuItem_default, _extends({
    ref
  }, other, {
    onClick,
    children: [icon && (0, import_jsx_runtime10.jsx)(ListItemIcon_default, {
      children: icon
    }), label]
  }));
});
true ? GridActionsCellItem.propTypes = {
  ...
  showInMenu: import_prop_types5.default.bool
} : void 0;
...
var _excluded4 = ["field", "align", "width", "contentWidth"];
...
function GridSkeletonCell(props) {
  ...
  return (0, import_jsx_runtime12.jsx)("div", _extends({
    className: classes.root,
    style: {
      width
    }
...
true ? GridSkeletonCell.propTypes = {
  ...
  // | To update them edit the TypeScript types and run "yarn proptypes"  |
  // ----------------------------------------------------------------------
  align: import_prop_types6.default.string.isRequired,
  contentWidth: import_prop_types6.default.number.isRequired,
...
var GridRoot = React14.forwardRef(function GridRoot2(props, ref) {
  const rootProps = useGridRootProps();
  const {
    children,
    className
  ...
  const rootContainerRef = React14.useRef(null);
  ...
  return (0, import_jsx_runtime13.jsx)(GridRootStyles, _extends({
    ref: handleRef,
    className: clsx_m_default(className, classes.root),
    ownerState,
    role: "grid",
...
var GridFooterContainer = React15.forwardRef(function GridFooterContainer2(props, ref) {
  const {
    className
  } = props, other = _objectWithoutPropertiesLoose(props, _excluded6);
  const rootProps = useGridRootProps();
  const classes = useUtilityClasses5(rootProps);
  return (0, import_jsx_runtime14.jsx)(GridFooterContainerRoot, _extends({
    ref,
...
var GridOverlay = React16.forwardRef(function GridOverlay2(props, ref) {
  const {
    className
  } = props, other = _objectWithoutPropertiesLoose(props, _excluded7);
  const rootProps = useGridRootProps();
  const classes = useUtilityClasses6(rootProps);
  return (0, import_jsx_runtime15.jsx)(GridOverlayRoot, _extends({
    ref,
    className: clsx_m_default(classes.root, className),
    ownerState: rootProps
  }, other));
...
var GridToolbarContainer = React17.forwardRef(function GridToolbarContainer2(props, ref) {
  const {
    className,
    children
  ...
  return (0, import_jsx_runtime16.jsx)(GridToolbarContainerRoot, _extends({
    ref,
    className: clsx_m_default(className, classes.root),
    ownerState: rootProps
  }, other, {
...
var GridIconButtonContainer = React18.forwardRef(function GridIconButtonContainer2(props, ref) {
  const {
    className
  } = props, other = _objectWithoutPropertiesLoose(props, _excluded9);
  const rootProps = useGridRootProps();
  const classes = useUtilityClasses8(rootProps);
  return (0, import_jsx_runtime17.jsx)(GridIconButtonContainerRoot, _extends({
    ref,
    className: clsx_m_default(classes.root, className),
    ownerState: rootProps
  }, other));
...
function getIcon(icons, direction, className, sortingOrder) {
  ...
  return Icon ? (0, import_jsx_runtime18.jsx)(Icon, _extends({
    fontSize: "small",
    className
  }, iconProps)) : null;
}
function GridColumnHeaderSortIconRaw(props) {
  ...
  const iconButton = (0, import_jsx_runtime18.jsx)(IconButton_default, {
    tabIndex: -1,
  ...
  return (0, import_jsx_runtime19.jsxs)(GridIconButtonContainer, {
    children: [index != null && (0, import_jsx_runtime18.jsx)(Badge_default, {
      badgeContent: index,
      color: "default",
      children: iconButton
...
var GridColumnHeaderSortIcon = React19.memo(GridColumnHeaderSortIconRaw);
true ? GridColumnHeaderSortIconRaw.propTypes = {
  // ----------------------------- Warning --------------------------------
  // | These PropTypes are generated from the TypeScript type definitions |
  // | To update them edit the TypeScript types and run "yarn proptypes"  |
  // ----------------------------------------------------------------------
  direction: import_prop_types11.default.oneOf(["asc", "desc"]),
  index: import_prop_types11.default.number,
  sortingOrder: import_prop_types11.default.arrayOf(import_prop_types11.default.oneOf(["asc", "desc"])).isRequired
} : void 0;
...
var ColumnHeaderMenuIcon = React20.memo((props) => {
  const {
    column,
    open,
    columnMenuId,
  ...
  const handleMenuIconClick = React20.useCallback((event) => {
  ...
  return (0, import_jsx_runtime20.jsx)("div", {
    ...
    children: (0, import_jsx_runtime20.jsx)(IconButton_default, {
      ...
      children: (0, import_jsx_runtime20.jsx)(rootProps.components.ColumnMenuIcon, {
        fontSize: "small"
      })
    })
  });
...
function GridColumnHeaderMenu({
  ...
  const hideMenu = React21.useCallback((event) => {
    event.stopPropagation();
  ...
  return (0, import_jsx_runtime21.jsx)(GridMenu, {
    ...
    onExited,
    children: (0, import_jsx_runtime21.jsx)(ContentComponent, _extends({
      currentColumn,
      hideMenu,
      open,
      id: columnMenuId,
...
true ? GridColumnHeaderMenu.propTypes = {
  ...
  // | To update them edit the TypeScript types and run "yarn proptypes"  |
  // ----------------------------------------------------------------------
  columnMenuButtonId: import_prop_types12.default.string,
  columnMenuId: import_prop_types12.default.string,
  ContentComponent: import_prop_types12.default.elementType.isRequired,
  contentComponentProps: import_prop_types12.default.any,
...
var ColumnHeaderInnerTitle = React22.forwardRef(function ColumnHeaderInnerTitle2(props, ref) {
  const {
    className
  } = props, other = _objectWithoutPropertiesLoose(props, _excluded10);
  const rootProps = useGridRootProps();
  const classes = useUtilityClasses11(rootProps);
  return (0, import_jsx_runtime22.jsx)(GridColumnHeaderTitleRoot, _extends({
    ref,
    className: clsx_m_default(classes.root, className),
    ownerState: rootProps
  }, other));
...
function GridColumnHeaderTitle(props) {
  ...
  const [tooltip, setTooltip] = React22.useState("");
  React22.useEffect(() => {
  ...
  return (0, import_jsx_runtime22.jsx)(rootProps.components.BaseTooltip, _extends({
    title: description || tooltip
  }, (_rootProps$components = rootProps.componentsProps) == null ? void 0 : _rootProps$components.baseTooltip, {
    children: (0, import_jsx_runtime22.jsx)(ColumnHeaderInnerTitle, {
      ref: titleRef,
      children: label
    })
  }));
...
true ? GridColumnHeaderTitle.propTypes = {
  ...
  // | To update them edit the TypeScript types and run "yarn proptypes"  |
  // ----------------------------------------------------------------------
  columnWidth: import_prop_types13.default.number.isRequired,
  description: import_prop_types13.default.node,
...
var _excluded11 = ["resizable", "resizing", "height", "side"];
...
function GridColumnHeaderSeparatorRaw(props) {
  ...
  const stopClick = React23.useCallback((event) => {
    event.preventDefault();
    event.stopPropagation();
  }, []);
  return (
    // eslint-disable-next-line jsx-a11y/click-events-have-key-events,jsx-a11y/no-static-element-interactions
    (0, import_jsx_runtime23.jsx)("div", _extends({
      className: classes.root,
      style: {
        minHeight: height,
      ...
      onClick: stopClick,
      children: (0, import_jsx_runtime23.jsx)(rootProps.components.ColumnResizeIcon, {
        className: classes.icon
      })
    }))
  );
}
var GridColumnHeaderSeparator = React23.memo(GridColumnHeaderSeparatorRaw);
true ? GridColumnHeaderSeparatorRaw.propTypes = {
  ...
  resizable: import_prop_types14.default.bool.isRequired,
  resizing: import_prop_types14.default.bool.isRequired,
  side: import_prop_types14.default.oneOf(["left", "right"])
} : void 0;

// node_modules/@mui/x-data-grid/components/columnHeaders/GridGenericColumnHeaderItem.js
var import_jsx_runtime24 = __toESM(require_jsx_runtime());
var import_jsx_runtime25 = __toESM(require_jsx_runtime());
var _excluded12 = ["classes", "columnMenuOpen", "colIndex", "height", "isResizing", "sortDirection", "hasFocus", "tabIndex", "separatorSide", "isDraggable", "headerComponent", "description", "elementId", "width", "columnMenuIconButton", "columnMenu", "columnTitleIconButtons", "headerClassName", "label", "resizable", "draggableContainerProps", "columnHeaderSeparatorProps", "disableHeaderSeparator"];
var GridGenericColumnHeaderItem = React24.forwardRef(function GridGenericColumnHeaderItem2(props, ref) {
  const {
    classes,
    columnMenuOpen,
    colIndex,
  ...
  const apiRef = useGridApiContext();
  const rootProps = useGridRootProps();
  const headerCellRef = React24.useRef(null);
  const [showColumnMenuIcon, setShowColumnMenuIcon] = React24.useState(columnMenuOpen);
  ...
  return (0, import_jsx_runtime25.jsxs)("div", _extends({
    ref: handleRef,
    ...
    children: [(0, import_jsx_runtime25.jsxs)("div", _extends({
      ...
      children: [(0, import_jsx_runtime25.jsxs)("div", {
        ...
        children: [(0, import_jsx_runtime24.jsx)("div", {
          ...
          children: headerComponent !== void 0 ? headerComponent : (0, import_jsx_runtime24.jsx)(GridColumnHeaderTitle, {
            label,
            description,
            columnWidth: width
          })
    ...
    })), !disableHeaderSeparator && (0, import_jsx_runtime24.jsx)(GridColumnHeaderSeparator, _extends({
...
function GridColumnHeaderItem(props) {
  ...
  const apiRef = useGridApiContext();
  const rootProps = useGridRootProps();
  const headerCellRef = React25.useRef(null);
  const columnMenuId = useId_default();
  const columnMenuButtonId = useId_default();
  const iconButtonRef = React25.useRef(null);
  const [showColumnMenuIcon, setShowColumnMenuIcon] = React25.useState(columnMenuOpen);
  const {
    hasScrollX,
    hasScrollY
  ...
  const isDraggable = React25.useMemo(() => !rootProps.disableColumnReorder && !disableReorder && !column.disableReorder, [rootProps.disableColumnReorder, disableReorder, column.disableReorder]);
  let headerComponent;
  ...
  const publish = React25.useCallback((eventName) => (event) => {
    if (!event.currentTarget.contains(event.target)) {
      return;
    }
    apiRef.current.publishEvent(eventName, apiRef.current.getColumnHeaderParams(column.field), event);
  }, [apiRef, column.field]);
  const mouseEventsHandlers = React25.useMemo(() => ({
  ...
  const draggableEventHandlers = React25.useMemo(() => isDraggable ? {
    onDragStart: publish("columnHeaderDragStart"),
    onDragEnter: publish("columnHeaderDragEnter"),
    onDragOver: publish("columnHeaderDragOver"),
    onDragEnd: publish("columnHeaderDragEnd")
  } : {}, [isDraggable, publish]);
  const columnHeaderSeparatorProps = React25.useMemo(() => ({
  ...
  const columnMenuIconButton = !rootProps.disableColumnMenu && !column.disableColumnMenu && (0, import_jsx_runtime26.jsx)(ColumnHeaderMenuIcon, {
    column,
    columnMenuId,
    columnMenuButtonId,
  ...
  const columnMenu = (0, import_jsx_runtime26.jsx)(GridColumnHeaderMenu, {
    columnMenuId,
    columnMenuButtonId,
    field: column.field,
    open: columnMenuOpen,
  ...
  const columnTitleIconButtons = (0, import_jsx_runtime27.jsxs)(React25.Fragment, {
    children: [!rootProps.disableColumnFilter && (0, import_jsx_runtime26.jsx)(rootProps.components.ColumnHeaderFilterIconButton, _extends({
      field: column.field,
      counter: filterItemsCounter
    }, (_rootProps$components2 = rootProps.componentsProps) == null ? void 0 : _rootProps$components2.columnHeaderFilterIconButton)), column.sortable && !column.hideSortIcons && (0, import_jsx_runtime26.jsx)(GridColumnHeaderSortIcon, {
  ...
  return (0, import_jsx_runtime26.jsx)(GridGenericColumnHeaderItem, _extends({
    ref: headerCellRef,
    classes,
    columnMenuOpen,
    colIndex,
...
true ? GridColumnHeaderItem.propTypes = {
  ...
  // | To update them edit the TypeScript types and run "yarn proptypes"  |
  // ----------------------------------------------------------------------
  colIndex: import_prop_types15.default.number.isRequired,
  column: import_prop_types15.default.object.isRequired,
  columnMenuOpen: import_prop_types15.default.bool.isRequired,
  disableReorder: import_prop_types15.default.bool,
  extendRowFullWidth: import_prop_types15.default.bool.isRequired,
  filterItemsCounter: import_prop_types15.default.number,
  hasFocus: import_prop_types15.default.bool,
  headerHeight: import_prop_types15.default.number.isRequired,
  isDragging: import_prop_types15.default.bool.isRequired,
  isLastColumn: import_prop_types15.default.bool.isRequired,
  isResizing: import_prop_types15.default.bool.isRequired,
  separatorSide: import_prop_types15.default.oneOf(["left", "right"]),
  sortDirection: import_prop_types15.default.oneOf(["asc", "desc"]),
  sortIndex: import_prop_types15.default.number,
  tabIndex: import_prop_types15.default.oneOf([-1, 0]).isRequired
} : void 0;
...
function GridColumnHeaderFilterIconButton(props) {
  ...
  const toggleFilter = React26.useCallback((event) => {
    event.preventDefault();
    event.stopPropagation();
    const {
      open,
  ...
  const iconButton = (0, import_jsx_runtime28.jsx)(IconButton_default, {
    onClick: toggleFilter,
    color: "default",
    "aria-label": apiRef.current.getLocaleText("columnHeaderFiltersLabel"),
    size: "small",
    tabIndex: -1,
    children: (0, import_jsx_runtime28.jsx)(rootProps.components.ColumnFilteredIcon, {
      className: classes.icon,
      fontSize: "small"
    })
  });
  return (0, import_jsx_runtime28.jsx)(rootProps.components.BaseTooltip, _extends({
    title: apiRef.current.getLocaleText("columnHeaderFiltersTooltipActive")(counter),
    enterDelay: 1e3
  }, (_rootProps$components = rootProps.componentsProps) == null ? void 0 : _rootProps$components.baseTooltip, {
    children: (0, import_jsx_runtime29.jsxs)(GridIconButtonContainer, {
      children: [counter > 1 && (0, import_jsx_runtime28.jsx)(Badge_default, {
...
true ? GridColumnHeaderFilterIconButton.propTypes = {
  ...
  // | To update them edit the TypeScript types and run "yarn proptypes"  |
  // ----------------------------------------------------------------------
  counter: import_prop_types16.default.number,
  field: import_prop_types16.default.string.isRequired,
...
var GridColumnsMenuItem = (props) => {
  ...
  const apiRef = useGridApiContext();
  const rootProps = useGridRootProps();
  const showColumns = React27.useCallback((event) => {
    onClick(event);
  ...
  return (0, import_jsx_runtime30.jsx)(MenuItem_default, {
    onClick: showColumns,
...
true ? GridColumnsMenuItem.propTypes = {
  ...
  onClick: import_prop_types17.default.func.isRequired
} : void 0;
...
var GridFilterMenuItem = (props) => {
  ...
  const apiRef = useGridApiContext();
  const rootProps = useGridRootProps();
  const showFilter = React28.useCallback((event) => {
    onClick(event);
  ...
  return (0, import_jsx_runtime31.jsx)(MenuItem_default, {
    onClick: showFilter,
...
true ? GridFilterMenuItem.propTypes = {
  ...
  // | To update them edit the TypeScript types and run "yarn proptypes"  |
  // ----------------------------------------------------------------------
  column: import_prop_types18.default.object.isRequired,
  onClick: import_prop_types18.default.func.isRequired
} : void 0;
...
var _excluded13 = ["hideMenu", "currentColumn", "open", "id", "labelledby", "className", "children"];
var GridColumnMenuContainer = React29.forwardRef(function GridColumnMenuContainer2(props, ref) {
  const {
    hideMenu,
    open,
    id,
  ...
  const handleListKeyDown = React29.useCallback((event) => {
  ...
  return (0, import_jsx_runtime32.jsx)(MenuList_default, _extends({
    id,
    ref,
...
true ? GridColumnMenuContainer.propTypes = {
  ...
  // | To update them edit the TypeScript types and run "yarn proptypes"  |
  // ----------------------------------------------------------------------
  currentColumn: import_prop_types19.default.object.isRequired,
  hideMenu: import_prop_types19.default.func.isRequired,
  id: import_prop_types19.default.string,
  labelledby: import_prop_types19.default.string,
...
var HideGridColMenuItem = (props) => {
  ...
  const toggleColumn = React30.useCallback((event) => {
    if (disabled) {
      return;
    }
    onClick(event);
  ...
  return (0, import_jsx_runtime33.jsx)(MenuItem_default, {
...
true ? HideGridColMenuItem.propTypes = {
  ...
  // | To update them edit the TypeScript types and run "yarn proptypes"  |
  // ----------------------------------------------------------------------
  column: import_prop_types20.default.object.isRequired,
...
function SortGridMenuItems(props) {
  ...
  const rootProps = useGridRootProps();
  const sortingOrder = (_column$sortingOrder = column.sortingOrder) != null ? _column$sortingOrder : rootProps.sortingOrder;
  const sortDirection = React31.useMemo(() => {
    if (!column) {
      return null;
    }
  ...
  const onSortMenuItemClick = React31.useCallback((event) => {
    onClick(event);
  ...
  return (0, import_jsx_runtime35.jsxs)(React31.Fragment, {
    children: [sortingOrder.includes(null) ? (0, import_jsx_runtime34.jsx)(MenuItem_default, {
      onClick: onSortMenuItemClick,
      disabled: sortDirection == null,
      children: apiRef.current.getLocaleText("columnMenuUnsort")
    }) : null, sortingOrder.includes("asc") ? (0, import_jsx_runtime34.jsx)(MenuItem_default, {
      onClick: onSortMenuItemClick,
      "data-value": "asc",
      disabled: sortDirection === "asc",
      children: apiRef.current.getLocaleText("columnMenuSortAsc")
    }) : null, sortingOrder.includes("desc") ? (0, import_jsx_runtime34.jsx)(MenuItem_default, {
      onClick: onSortMenuItemClick,
      "data-value": "desc",
...
true ? SortGridMenuItems.propTypes = {
  ...
  onClick: import_prop_types21.default.func.isRequired
} : void 0;

// node_modules/@mui/x-data-grid/components/menu/columnMenu/GridColumnMenu.js
var import_jsx_runtime36 = __toESM(require_jsx_runtime());
var GridColumnMenu = React32.forwardRef(function GridColumnMenu2(props, ref) {
  const {
    hideMenu,
    currentColumn
  } = props;
  ...
  const defaultButtons = [
    (0, import_jsx_runtime36.jsx)(SortGridMenuItems, {
      onClick: hideMenu,
      column: currentColumn
    }),
    // TODO update types to allow `onClick` and `column` to be optional
    (0, import_jsx_runtime36.jsx)(GridFilterMenuItem, {
      onClick: hideMenu,
      column: currentColumn
    }),
    (0, import_jsx_runtime36.jsx)(HideGridColMenuItem, {
      onClick: hideMenu,
      column: currentColumn
    }),
    (0, import_jsx_runtime36.jsx)(GridColumnsMenuItem, {
      onClick: hideMenu,
      column: currentColumn
    })
  ];
  const preProcessedButtons = apiRef.current.unstable_applyPipeProcessors("columnMenu", defaultButtons, currentColumn);
  return (0, import_jsx_runtime36.jsx)(GridColumnMenuContainer, _extends({
    ref
  }, props, {
    children: preProcessedButtons.map((button, index) => React32.cloneElement(button, {
      key: index,
      onClick: hideMenu,
      column: currentColumn
    }))
...
true ? GridColumnMenu.propTypes = {
  ...
  // | To update them edit the TypeScript types and run "yarn proptypes"  |
  // ----------------------------------------------------------------------
  currentColumn: import_prop_types22.default.object.isRequired,
  hideMenu: import_prop_types22.default.func.isRequired,
...
function GridPanelContent(props) {
  ...
  return (0, import_jsx_runtime37.jsx)(GridPanelContentRoot, _extends({
    className: clsx_m_default(className, classes.root),
    ownerState: rootProps
  }, other));
}
...
function GridPanelFooter(props) {
  ...
  const rootProps = useGridRootProps();
  const classes = useUtilityClasses16(rootProps);
  return (0, import_jsx_runtime38.jsx)(GridPanelFooterRoot, _extends({
    className: clsx_m_default(className, classes.root),
    ownerState: rootProps
  }, other));
}
...
function GridPanelHeader(props) {
  ...
  return (0, import_jsx_runtime39.jsx)(GridPanelHeaderRoot, _extends({
    className: clsx_m_default(className, classes.root),
    ownerState: rootProps
  }, other));
}
...
var _excluded17 = ["className", "slotProps"];
...
var isEnabled = () => true;
var GridPanelWrapper = React36.forwardRef(function GridPanelWrapper2(props, ref) {
  const {
    className,
    slotProps = {}
  ...
  return (0, import_jsx_runtime40.jsx)(FocusTrap_default, _extends({
    open: true,
    disableEnforceFocus: true,
    isEnabled
  }, slotProps.TrapFocus, {
    children: (0, import_jsx_runtime40.jsx)(GridPanelWrapperRoot, _extends({
      ref,
      tabIndex: -1,
      className: clsx_m_default(className, classes.root),
      ownerState: rootProps
...
true ? GridPanelWrapper.propTypes = {
  ...
  slotProps: import_prop_types26.default.shape({
    TrapFocus: import_prop_types26.default.shape({
...
var _excluded18 = ["sort", "searchPredicate", "autoFocusSearchField"];
...
function GridColumnsPanel(props) {
  ...
  const rootProps = useGridRootProps();
  const [searchValue, setSearchValue] = React37.useState("");
  ...
  const sortedColumns = React37.useMemo(() => {
    switch (sort) {
      case "asc":
  ...
  const toggleAllColumns = React37.useCallback((isVisible) => {
  ...
  const handleSearchValueChange = React37.useCallback((event) => {
    setSearchValue(event.target.value);
  }, []);
  const currentColumns = React37.useMemo(() => {
    if (!searchValue) {
  ...
  const firstSwitchRef = React37.useRef(null);
  React37.useEffect(() => {
  ...
  return (0, import_jsx_runtime42.jsxs)(GridPanelWrapper, _extends({}, other, {
    children: [(0, import_jsx_runtime41.jsx)(GridPanelHeader, {
      children: (0, import_jsx_runtime41.jsx)(rootProps.components.BaseTextField, _extends({
    ...
    }), (0, import_jsx_runtime41.jsx)(GridPanelContent, {
      children: (0, import_jsx_runtime41.jsx)(GridColumnsPanelRoot, {
        className: classes.root,
        ownerState: rootProps,
        children: currentColumns.map((column) => {
          var _rootProps$components2;
          return (0, import_jsx_runtime42.jsxs)(GridColumnsPanelRowRoot, {
            className: classes.columnsPanelRow,
            ownerState: rootProps,
            children: [(0, import_jsx_runtime41.jsx)(FormControlLabel_default, {
              control: (0, import_jsx_runtime41.jsx)(rootProps.components.BaseSwitch, _extends({
            ...
            }), !rootProps.disableColumnReorder && GRID_EXPERIMENTAL_ENABLED && (0, import_jsx_runtime41.jsx)(GridIconButtonRoot, {
              draggable: true,
              "aria-label": apiRef.current.getLocaleText("columnsPanelDragIconLabel"),
              title: apiRef.current.getLocaleText("columnsPanelDragIconLabel"),
              size: "small",
              disabled: true,
              children: (0, import_jsx_runtime41.jsx)(GridDragIcon, {})
            })]
          }, column.field);
        })
      })
    }), (0, import_jsx_runtime42.jsxs)(GridPanelFooter, {
      children: [(0, import_jsx_runtime41.jsx)(rootProps.components.BaseButton, _extends({
        onClick: () => toggleAllColumns(false)
      }, (_rootProps$components3 = rootProps.componentsProps) == null ? void 0 : _rootProps$components3.baseButton, {
        children: apiRef.current.getLocaleText("columnsPanelHideAllButton")
      })), (0, import_jsx_runtime41.jsx)(rootProps.components.BaseButton, _extends({
...
true ? GridColumnsPanel.propTypes = {
  ...
  // | To update them edit the TypeScript types and run "yarn proptypes"  |
  // ----------------------------------------------------------------------
  autoFocusSearchField: import_prop_types27.default.bool,
  searchPredicate: import_prop_types27.default.func,
  slotProps: import_prop_types27.default.shape({
    TrapFocus: import_prop_types27.default.shape({
  ...
  sort: import_prop_types27.default.oneOf(["asc", "desc"])
} : void 0;
...
var _excluded19 = ["children", "className", "classes"];
...
var GridPanel = React38.forwardRef((props, ref) => {
  ...
  const [isPlaced, setIsPlaced] = React38.useState(false);
  const handleClickAway = React38.useCallback(() => {
  ...
  const modifiers = React38.useMemo(() => [{
    name: "flip",
    enabled: false
  }, {
    name: "isPlaced",
  ...
  return (0, import_jsx_runtime43.jsx)(GridPanelRoot, _extends({
    ref,
    ...
    children: (0, import_jsx_runtime43.jsx)(ClickAwayListener, {
      mouseEvent: "onMouseUp",
      onClickAway: handleClickAway,
      children: (0, import_jsx_runtime43.jsx)(GridPaperRoot, {
...
var GridPreferencesPanel = React39.forwardRef(function GridPreferencesPanel2(props, ref) {
  ...
  return (0, import_jsx_runtime44.jsx)(rootProps.components.Panel, _extends({
    ref,
...
var _excluded20 = ["item", "hasMultipleFilters", "deleteFilter", "applyFilterChanges", "multiFilterOperator", "showMultiFilterOperators", "disableMultiFilterOperator", "applyMultiFilterOperatorChanges", "focusElementRef", "linkOperators", "columnsSort", "deleteIconProps", "linkOperatorInputProps", "operatorInputProps", "columnInputProps", "valueInputProps", "children"];
var _excluded22 = ["InputComponentProps"];
...
var GridFilterForm = React40.forwardRef(function GridFilterForm2(props, ref) {
  ...
  const valueRef = React40.useRef(null);
  const filterSelectorRef = React40.useRef(null);
  ...
  const {
    InputComponentProps
  } = valueInputProps, valueInputPropsOther = _objectWithoutPropertiesLoose(valueInputProps, _excluded22);
  const sortedFilterableColumns = React40.useMemo(() => {
    switch (columnsSort) {
      case "asc":
  ...
  const currentOperator = React40.useMemo(() => {
  ...
  const changeColumn = React40.useCallback((event) => {
  ...
  const changeOperator = React40.useCallback((event) => {
  ...
  const changeLinkOperator = React40.useCallback((event) => {
  ...
  React40.useImperativeHandle(focusElementRef, () => ({
    focus: () => {
  ...
  return (0, import_jsx_runtime46.jsxs)(GridFilterFormRoot, _extends({
    ref,
    className: classes.root,
    ownerState: rootProps
  }, other, {
    children: [(0, import_jsx_runtime45.jsx)(FilterFormDeleteIcon, _extends({
      variant: "standard",
      as: rootProps.components.BaseFormControl
    }, baseFormControlProps, deleteIconProps, {
      className: clsx_m_default(classes.deleteIcon, baseFormControlProps.className, deleteIconProps.className),
      ownerState: rootProps,
      children: (0, import_jsx_runtime45.jsx)(IconButton_default, {
        "aria-label": apiRef.current.getLocaleText("filterPanelDeleteIconLabel"),
        title: apiRef.current.getLocaleText("filterPanelDeleteIconLabel"),
        onClick: handleDeleteFilter,
        size: "small",
        children: (0, import_jsx_runtime45.jsx)(rootProps.components.FilterPanelDeleteIcon, {
          fontSize: "small"
        })
      })
    })), (0, import_jsx_runtime45.jsx)(FilterFormLinkOperatorInput, _extends({
      variant: "standard",
      as: rootProps.components.BaseFormControl
      ...
      ownerState: rootProps,
      children: (0, import_jsx_runtime45.jsx)(rootProps.components.BaseSelect, _extends({
        inputProps: {
        ...
        children: linkOperators.map((linkOperator) => (0, import_jsx_runtime45.jsx)(OptionComponent, {
          value: linkOperator.toString(),
          children: apiRef.current.getLocaleText(getLinkOperatorLocaleKey(linkOperator))
        }, linkOperator.toString()))
      }))
    })), (0, import_jsx_runtime46.jsxs)(FilterFormColumnInput, _extends({
      variant: "standard",
      as: rootProps.components.BaseFormControl
    }, baseFormControlProps, columnInputProps, {
      className: clsx_m_default(classes.columnInput, baseFormControlProps.className, columnInputProps.className),
      ownerState: rootProps,
      children: [(0, import_jsx_runtime45.jsx)(InputLabel_default, {
        htmlFor: columnSelectId,
        id: columnSelectLabelId,
        children: apiRef.current.getLocaleText("filterPanelColumns")
      }), (0, import_jsx_runtime45.jsx)(rootProps.components.BaseSelect, _extends({
        ...
        children: sortedFilterableColumns.map((col) => (0, import_jsx_runtime45.jsx)(OptionComponent, {
          value: col.field,
          children: getColumnLabel(col)
        }, col.field))
      }))]
    })), (0, import_jsx_runtime46.jsxs)(FilterFormOperatorInput, _extends({
      variant: "standard",
      as: rootProps.components.BaseFormControl
      ...
      children: [(0, import_jsx_runtime45.jsx)(InputLabel_default, {
        ...
        children: currentColumn == null ? void 0 : (_currentColumn$filter2 = currentColumn.filterOperators) == null ? void 0 : _currentColumn$filter2.map((operator) => (0, import_jsx_runtime45.jsx)(OptionComponent, {
          value: operator.value,
          children: operator.label || apiRef.current.getLocaleText(`filterOperator${capitalize_default(operator.value)}`)
        }, operator.value))
      }))]
    })), (0, import_jsx_runtime45.jsx)(FilterFormValueInput, _extends({
      variant: "standard",
      as: rootProps.components.BaseFormControl
    }, baseFormControlProps, valueInputPropsOther, {
      className: clsx_m_default(classes.valueInput, baseFormControlProps.className, valueInputPropsOther.className),
      ownerState: rootProps,
      children: currentOperator != null && currentOperator.InputComponent ? (0, import_jsx_runtime45.jsx)(currentOperator.InputComponent, _extends({
        apiRef,
        item,
...
true ? GridFilterForm.propTypes = {
   ...
   */
  applyFilterChanges: import_prop_types29.default.func.isRequired,
  /**
   * Callback called when the logic operator is changed.
   * @param {GridLinkOperator} operator The new logic operator.
   */
  applyMultiFilterOperatorChanges: import_prop_types29.default.func.isRequired,
  /**
   ...
   * @default {}
   */
  columnInputProps: import_prop_types29.default.any,
  /**
   * Changes how the options in the columns selector should be ordered.
   * If not specified, the order is derived from the `columns` prop.
   */
  columnsSort: import_prop_types29.default.oneOf(["asc", "desc"]),
  /**
   * Callback called when the delete button is clicked.
   * @param {GridFilterItem} item The deleted [[GridFilterItem]].
   */
  deleteFilter: import_prop_types29.default.func.isRequired,
  /**
   * Props passed to the delete icon.
   * @default {}
   */
  deleteIconProps: import_prop_types29.default.any,
  /**
   * If `true`, disables the logic operator field but still renders it.
   */
  disableMultiFilterOperator: import_prop_types29.default.bool,
  /**
   ...
   */
  hasMultipleFilters: import_prop_types29.default.bool.isRequired,
  /**
   ...
   * @default {}
   */
  linkOperatorInputProps: import_prop_types29.default.any,
  /**
   * Sets the available logic operators.
   * @default [GridLinkOperator.And, GridLinkOperator.Or]
   */
  linkOperators: import_prop_types29.default.arrayOf(import_prop_types29.default.oneOf(["and", "or"]).isRequired),
  /**
   * The current logic operator applied.
   */
  multiFilterOperator: import_prop_types29.default.oneOf(["and", "or"]),
  /**
   * Props passed to the operator input component.
   * @default {}
   */
  operatorInputProps: import_prop_types29.default.any,
  /**
   * If `true`, the logic operator field is visible.
   */
  showMultiFilterOperators: import_prop_types29.default.bool,
  /**
   * Props passed to the value input component.
   * @default {}
   */
  valueInputProps: import_prop_types29.default.any
} : void 0;
...
var _excluded21 = ["linkOperators", "columnsSort", "filterFormProps", "children"];
var GridFilterPanel = React41.forwardRef(function GridFilterPanel2(props, ref) {
  var _rootProps$components;
  const apiRef = useGridApiContext();
  const rootProps = useGridRootProps();
  const filterModel = useGridSelector(apiRef, gridFilterModelSelector);
  const filterableColumns = useGridSelector(apiRef, gridFilterableColumnDefinitionsSelector);
  const lastFilterRef = React41.useRef(null);
  const {
    linkOperators = [GridLinkOperator.And, GridLinkOperator.Or],
    columnsSort,
    filterFormProps
  } = props, other = _objectWithoutPropertiesLoose(props, _excluded21);
  const applyFilter = React41.useCallback((item) => {
    apiRef.current.upsertFilterItem(item);
  }, [apiRef]);
  const applyFilterLinkOperator = React41.useCallback((operator) => {
    apiRef.current.setFilterLinkOperator(operator);
  }, [apiRef]);
  const getDefaultItem = React41.useCallback(() => {
  ...
  const deleteFilter = React41.useCallback((item) => {
  ...
  return (0, import_jsx_runtime48.jsxs)(GridPanelWrapper, _extends({
    ref
  }, other, {
    children: [(0, import_jsx_runtime47.jsx)(GridPanelContent, {
      children: items.map((item, index) => (0, import_jsx_runtime47.jsx)(GridFilterForm, _extends({
        item,
    ...
    }), !rootProps.disableMultipleColumnsFiltering && (0, import_jsx_runtime47.jsx)(GridPanelFooter, {
      children: (0, import_jsx_runtime47.jsx)(rootProps.components.BaseButton, _extends({
        onClick: addNewFilter,
        startIcon: (0, import_jsx_runtime47.jsx)(GridAddIcon, {})
...
true ? GridFilterPanel.propTypes = {
   ...
   * If not specified, the order is derived from the `columns` prop.
   */
  columnsSort: import_prop_types30.default.oneOf(["asc", "desc"]),
  /**
   * Props passed to each filter form.
   */
  filterFormProps: import_prop_types30.default.shape({
    columnInputProps: import_prop_types30.default.any,
    columnsSort: import_prop_types30.default.oneOf(["asc", "desc"]),
    deleteIconProps: import_prop_types30.default.any,
    linkOperatorInputProps: import_prop_types30.default.any,
    operatorInputProps: import_prop_types30.default.any,
    valueInputProps: import_prop_types30.default.any
  }),
  /**
   * Sets the available logic operators.
   * @default [GridLinkOperator.And, GridLinkOperator.Or]
   */
  linkOperators: import_prop_types30.default.arrayOf(import_prop_types30.default.oneOf(["and", "or"]).isRequired),
  /**
   * The system prop that allows defining system overrides as well as additional CSS styles.
   */
...
var _excluded23 = ["onClick"];
var GridToolbarColumnsButton = React42.forwardRef(function GridToolbarColumnsButton2(props, ref) {
  var _rootProps$components;
  const {
    onClick
  ...
  return (0, import_jsx_runtime49.jsx)(rootProps.components.BaseButton, _extends({
    ref,
    size: "small",
    "aria-label": apiRef.current.getLocaleText("toolbarColumnsLabel"),
    startIcon: (0, import_jsx_runtime49.jsx)(rootProps.components.ColumnSelectorIcon, {})
  }, other, {
    onClick: showColumns
  }, (_rootProps$components = rootProps.componentsProps) == null ? void 0 : _rootProps$components.baseButton, {
...
var _excluded24 = ["onClick"];
var GridToolbarDensitySelector = React43.forwardRef(function GridToolbarDensitySelector2(props, ref) {
  var _rootProps$components;
  const {
    onClick
  ...
  const densityOptions = [{
    icon: (0, import_jsx_runtime50.jsx)(rootProps.components.DensityCompactIcon, {}),
    label: apiRef.current.getLocaleText("toolbarDensityCompact"),
    value: GridDensityTypes.Compact
  }, {
    icon: (0, import_jsx_runtime50.jsx)(rootProps.components.DensityStandardIcon, {}),
    label: apiRef.current.getLocaleText("toolbarDensityStandard"),
    value: GridDensityTypes.Standard
  }, {
    icon: (0, import_jsx_runtime50.jsx)(rootProps.components.DensityComfortableIcon, {}),
    label: apiRef.current.getLocaleText("toolbarDensityComfortable"),
    value: GridDensityTypes.Comfortable
  }];
  const startIcon = React43.useMemo(() => {
    switch (densityValue) {
      case GridDensityTypes.Compact:
        return (0, import_jsx_runtime50.jsx)(rootProps.components.DensityCompactIcon, {});
      case GridDensityTypes.Comfortable:
        return (0, import_jsx_runtime50.jsx)(rootProps.components.DensityComfortableIcon, {});
      default:
        return (0, import_jsx_runtime50.jsx)(rootProps.components.DensityStandardIcon, {});
    }
  ...
  const densityElements = densityOptions.map((option, index) => (0, import_jsx_runtime51.jsxs)(MenuItem_default, {
  ...
  return (0, import_jsx_runtime51.jsxs)(React43.Fragment, {
    children: [(0, import_jsx_runtime50.jsx)(rootProps.components.BaseButton, _extends({
      ref: handleRef,
      size: "small",
      startIcon,
    ...
    })), (0, import_jsx_runtime50.jsx)(GridMenu, {
      open,
      target: buttonRef.current,
      onClickAway: handleDensitySelectorClickAway,
      position: "bottom-start",
      children: (0, import_jsx_runtime50.jsx)(MenuList_default, {
        id: densityMenuId,
...
var _excluded25 = ["componentsProps"];
...
var GridToolbarFilterButton = React44.forwardRef(function GridToolbarFilterButton2(props, ref) {
  ...
  const tooltipContentNode = React44.useMemo(() => {
    ...
    return (0, import_jsx_runtime53.jsxs)("div", {
      children: [apiRef.current.getLocaleText("toolbarFiltersTooltipActive")(activeFilters.length), (0, import_jsx_runtime52.jsx)(GridToolbarFilterListRoot, {
        className: classes.root,
        ownerState: rootProps,
        children: activeFilters.map((item, index) => _extends({}, lookup[item.columnField] && (0, import_jsx_runtime52.jsx)("li", {
  ...
  return (0, import_jsx_runtime52.jsx)(rootProps.components.BaseTooltip, _extends({
    title: tooltipContentNode,
    enterDelay: 1e3
  }, other, (_rootProps$components = rootProps.componentsProps) == null ? void 0 : _rootProps$components.baseTooltip, {
    children: (0, import_jsx_runtime52.jsx)(rootProps.components.BaseButton, _extends({
      ref,
      size: "small",
      "aria-label": apiRef.current.getLocaleText("toolbarFiltersLabel"),
      startIcon: (0, import_jsx_runtime52.jsx)(Badge_default, {
        badgeContent: activeFilters.length,
        color: "primary",
        children: (0, import_jsx_runtime52.jsx)(rootProps.components.OpenFilterButtonIcon, {})
      })
    }, buttonProps, {
      onClick: toggleFilter
...
var _excluded26 = ["children", "onClick"];
var GridToolbarExportContainer = React45.forwardRef(function GridToolbarExportContainer2(props, ref) {
  var _rootProps$components;
  const {
    children,
    onClick
  ...
  return (0, import_jsx_runtime55.jsxs)(React45.Fragment, {
    children: [(0, import_jsx_runtime54.jsx)(rootProps.components.BaseButton, _extends({
      ref: handleRef,
      size: "small",
      startIcon: (0, import_jsx_runtime54.jsx)(rootProps.components.ExportIcon, {}),
      "aria-expanded": open ? "true" : void 0,
    ...
    })), (0, import_jsx_runtime54.jsx)(GridMenu, {
      open,
      target: buttonRef.current,
      onClickAway: handleMenuClickAway,
      position: "bottom-start",
      children: (0, import_jsx_runtime54.jsx)(MenuList_default, {
        id: menuId,
        className: gridClasses.menuList,
...
var _excluded27 = ["hideMenu", "options"];
var _excluded28 = ["hideMenu", "options"];
var _excluded32 = ["csvOptions", "printOptions", "excelOptions"];
var GridCsvExportMenuItem = (props) => {
  ...
  return (0, import_jsx_runtime56.jsx)(MenuItem_default, _extends({
    onClick: () => {
...
var GridToolbarExport = React46.forwardRef(function GridToolbarExport2(props, ref) {
  const {
    csvOptions = {},
    printOptions = {},
    excelOptions
  ...
  return (0, import_jsx_runtime56.jsx)(GridToolbarExportContainer, _extends({}, other, {
    ref,
    children: preProcessedButtons.map((button, index) => React46.cloneElement(button.component, {
      key: index
    }))
  }));
});
true ? GridToolbarExport.propTypes = {
  ...
  // | To update them edit the TypeScript types and run "yarn proptypes"  |
  // ----------------------------------------------------------------------
  csvOptions: import_prop_types32.default.object,
  printOptions: import_prop_types32.default.object
} : void 0;
...
var _excluded29 = ["quickFilterParser", "quickFilterFormatter", "debounceMs"];
...
function GridToolbarQuickFilter(props) {
  ...
  const [searchValue, setSearchValue] = React47.useState(() => quickFilterFormatter(quickFilterValues != null ? quickFilterValues : []));
  const [prevQuickFilterValues, setPrevQuickFilterValues] = React47.useState(quickFilterValues);
  React47.useEffect(() => {
  ...
  const updateSearchValue = React47.useCallback((newSearchValue) => {
    apiRef.current.setQuickFilterValues(quickFilterParser(newSearchValue));
  }, [apiRef, quickFilterParser]);
  const debouncedUpdateSearchValue = React47.useMemo(() => debounce_default(updateSearchValue, debounceMs), [updateSearchValue, debounceMs]);
  const handleSearchValueChange = React47.useCallback((event) => {
    const newSearchValue = event.target.value;
    setSearchValue(newSearchValue);
    debouncedUpdateSearchValue(newSearchValue);
  }, [debouncedUpdateSearchValue]);
  const handleSearchReset = React47.useCallback(() => {
    setSearchValue("");
    updateSearchValue("");
  }, [updateSearchValue]);
  return (0, import_jsx_runtime57.jsx)(GridToolbarQuickFilterRoot, _extends({
    ...
    type: "search",
    InputProps: {
      startAdornment: (0, import_jsx_runtime57.jsx)(rootProps.components.QuickFilterIcon, {
        fontSize: "small"
      }),
      endAdornment: (0, import_jsx_runtime57.jsx)(IconButton_default, {
        ...
        children: (0, import_jsx_runtime57.jsx)(rootProps.components.QuickFilterClearIcon, {
          fontSize: "small"
        })
      })
    }
...
true ? GridToolbarQuickFilter.propTypes = {
   ...
   * @default 500
   */
  debounceMs: import_prop_types33.default.number,
  /**
   * Function responsible for formatting values of quick filter in a string when the model is modified
   * @param {any[]} values The new values passed to the quick filter model
   * @returns {string} The string to display in the text field
   */
  quickFilterFormatter: import_prop_types33.default.func,
  /**
   * Function responsible for parsing text input in an array of independent values for quick filtering.
   * @param {string} input The value entered by the user
   * @returns {any[]} The array of value on which quick filter is applied
   */
  quickFilterParser: import_prop_types33.default.func
} : void 0;

// node_modules/@mui/x-data-grid/components/toolbar/GridToolbar.js
var import_jsx_runtime58 = __toESM(require_jsx_runtime());
var import_jsx_runtime59 = __toESM(require_jsx_runtime());
var _excluded30 = ["className", "csvOptions", "printOptions", "excelOptions", "showQuickFilter", "quickFilterProps"];
var GridToolbar = React48.forwardRef(function GridToolbar2(props, ref) {
  const {
    csvOptions,
    printOptions,
    excelOptions,
  ...
  return (0, import_jsx_runtime59.jsxs)(GridToolbarContainer, _extends({
    ref
  }, other, {
    children: [(0, import_jsx_runtime58.jsx)(GridToolbarColumnsButton, {}), (0, import_jsx_runtime58.jsx)(GridToolbarFilterButton, {}), (0, import_jsx_runtime58.jsx)(GridToolbarDensitySelector, {}), (0, import_jsx_runtime58.jsx)(GridToolbarExport, {
      csvOptions,
      printOptions,
      excelOptions
    }), (0, import_jsx_runtime58.jsx)(Box_default, {
      sx: {
        flex: 1
      }
    }), showQuickFilter && (0, import_jsx_runtime58.jsx)(GridToolbarQuickFilter, _extends({}, quickFilterProps))]
  }));
});
true ? GridToolbar.propTypes = {
   ...
   */
  quickFilterProps: import_prop_types34.default.object,
  /**
   * Show the quick filter component.
   * @default false
   */
  showQuickFilter: import_prop_types34.default.bool,
...
var _excluded31 = ["className", "rowCount", "visibleRowCount"];
...
var GridRowCount = React49.forwardRef(function GridRowCount2(props, ref) {
  const {
    className,
    rowCount,
    visibleRowCount
  ...
  return (0, import_jsx_runtime60.jsxs)(GridRowCountRoot, _extends({
    ref,
    className: clsx_m_default(classes.root, className),
    ownerState
  }, other, {
...
true ? GridRowCount.propTypes = {
  ...
  // | To update them edit the TypeScript types and run "yarn proptypes"  |
  // ----------------------------------------------------------------------
  rowCount: import_prop_types35.default.number.isRequired,
  sx: import_prop_types35.default.oneOfType([import_prop_types35.default.arrayOf(import_prop_types35.default.oneOfType([import_prop_types35.default.func, import_prop_types35.default.object, import_prop_types35.default.bool])), import_prop_types35.default.func, import_prop_types35.default.object]),
  visibleRowCount: import_prop_types35.default.number.isRequired
} : void 0;
...
var _excluded33 = ["className", "selectedRowCount"];
...
var GridSelectedRowCount = React50.forwardRef(function GridSelectedRowCount2(props, ref) {
  const {
    className,
    selectedRowCount
  ...
  return (0, import_jsx_runtime61.jsx)(GridSelectedRowCountRoot, _extends({
    ref,
    className: clsx_m_default(classes.root, className),
    ownerState
  }, other, {
...
true ? GridSelectedRowCount.propTypes = {
  ...
  // | To update them edit the TypeScript types and run "yarn proptypes"  |
  // ----------------------------------------------------------------------
  selectedRowCount: import_prop_types36.default.number.isRequired,
...
var GridFooter = React51.forwardRef(function GridFooter2(props, ref) {
  var _rootProps$components;
  const apiRef = useGridApiContext();
  const rootProps = useGridRootProps();
  ...
  const selectedRowCountElement = !rootProps.hideFooterSelectedRowCount && selectedRowCount > 0 ? (0, import_jsx_runtime62.jsx)(GridSelectedRowCount, {
    selectedRowCount
  }) : (0, import_jsx_runtime62.jsx)("div", {});
  const rowCountElement = !rootProps.hideFooterRowCount && !rootProps.pagination ? (0, import_jsx_runtime62.jsx)(GridRowCount, {
    rowCount: totalTopLevelRowCount,
    visibleRowCount: visibleTopLevelRowCount
  }) : null;
  const paginationElement = rootProps.pagination && !rootProps.hideFooterPagination && rootProps.components.Pagination && (0, import_jsx_runtime62.jsx)(rootProps.components.Pagination, _extends({}, (_rootProps$components = rootProps.componentsProps) == null ? void 0 : _rootProps$components.pagination));
  return (0, import_jsx_runtime63.jsxs)(GridFooterContainer, _extends({
    ref
  }, props, {
...
var GridHeader = React52.forwardRef(function GridHeader2(props, ref) {
  var _rootProps$components, _rootProps$components2;
  const rootProps = useGridRootProps();
  return (0, import_jsx_runtime65.jsxs)("div", _extends({
    ref
  }, props, {
    children: [(0, import_jsx_runtime64.jsx)(rootProps.components.PreferencesPanel, _extends({}, (_rootProps$components = rootProps.componentsProps) == null ? void 0 : _rootProps$components.preferencesPanel)), rootProps.components.Toolbar && (0, import_jsx_runtime64.jsx)(rootProps.components.Toolbar, _extends({}, (_rootProps$components2 = rootProps.componentsProps) == null ? void 0 : _rootProps$components2.toolbar))]
  }));
});
...
var GridLoadingOverlay = React53.forwardRef(function GridLoadingOverlay2(props, ref) {
  return (0, import_jsx_runtime66.jsx)(GridOverlay, _extends({
    ref
  }, props, {
    children: (0, import_jsx_runtime66.jsx)(CircularProgress_default, {})
  }));
});
...
var GridNoRowsOverlay = React54.forwardRef(function GridNoRowsOverlay2(props, ref) {
  const apiRef = useGridApiContext();
  const noRowsLabel = apiRef.current.getLocaleText("noRowsLabel");
  return (0, import_jsx_runtime67.jsx)(GridOverlay, _extends({
    ref
  }, props, {
...
var GridPagination = React55.forwardRef(function GridPagination2(props, ref) {
  var _rootProps$rowsPerPag;
  const apiRef = useGridApiContext();
  const rootProps = useGridRootProps();
  const paginationState = useGridSelector(apiRef, gridPaginationSelector);
  const lastPage = React55.useMemo(() => Math.floor(paginationState.rowCount / (paginationState.pageSize || 1)), [paginationState.rowCount, paginationState.pageSize]);
  const handlePageSizeChange = React55.useCallback((event) => {
    const newPageSize = Number(event.target.value);
    apiRef.current.setPageSize(newPageSize);
  }, [apiRef]);
  const handlePageChange = React55.useCallback((event, page) => {
    apiRef.current.setPage(page);
  }, [apiRef]);
  if (true) {
    var _rootProps$pageSize;
    const warnedOnceMissingPageSizeInRowsPerPageOptions = React55.useRef(false);
  ...
  return (0, import_jsx_runtime68.jsx)(GridPaginationRoot, _extends({
    ref,
    component: "div",
...
var _excluded34 = ["selected", "rowId", "row", "index", "style", "position", "rowHeight", "className", "visibleColumns", "renderedColumns", "containerWidth", "firstColumnToRender", "lastColumnToRender", "cellFocus", "cellTabIndex", "editRowsState", "isLastVisible", "onClick", "onDoubleClick", "onMouseEnter", "onMouseLeave"];
var _excluded210 = ["changeReason"];
...
var GridRow = React57.forwardRef(function GridRow2(props, refProp) {
  ...
  const publish = React57.useCallback((eventName, propHandler) => (event) => {
  ...
  const publishClick = React57.useCallback((event) => {
  ...
  const getCell = React57.useCallback((column, cellProps) => {
    var _rootProps$components;
    ...
    return (0, import_jsx_runtime69.jsx)(rootProps.components.Cell, _extends({
  ...
  for (let i = 0; i < renderedColumns.length; i += 1) {
    ...
    if (cellColSpanInfo && !cellColSpanInfo.spannedByColSpan) {
      if (row) {
        ...
        cells.push((0, import_jsx_runtime69.jsx)(rootProps.components.SkeletonCell, {
          width,
          contentWidth,
          field: column.field,
          align: column.align
  ...
  return (0, import_jsx_runtime70.jsxs)("div", _extends({
    ref: handleRef,
    "data-id": rowId,
    "data-rowindex": index,
    role: "row",
    ...
    children: [cells, emptyCellWidth > 0 && (0, import_jsx_runtime69.jsx)(EmptyCell, {
...
true ? GridRow.propTypes = {
  ...
  // | To update them edit the TypeScript types and run "yarn proptypes"  |
  // ----------------------------------------------------------------------
  cellFocus: import_prop_types40.default.object,
  cellTabIndex: import_prop_types40.default.object,
  containerWidth: import_prop_types40.default.number.isRequired,
  editRowsState: import_prop_types40.default.object.isRequired,
  firstColumnToRender: import_prop_types40.default.number.isRequired,
  /**
   * Index of the row in the whole sorted and filtered dataset.
   * If some rows above have expanded children, this index also take those children into account.
   */
  index: import_prop_types40.default.number.isRequired,
  isLastVisible: import_prop_types40.default.bool,
  lastColumnToRender: import_prop_types40.default.number.isRequired,
  position: import_prop_types40.default.oneOf(["center", "left", "right"]).isRequired,
  renderedColumns: import_prop_types40.default.arrayOf(import_prop_types40.default.object).isRequired,
  row: import_prop_types40.default.object,
  rowHeight: import_prop_types40.default.oneOfType([import_prop_types40.default.oneOf(["auto"]), import_prop_types40.default.number]).isRequired,
  rowId: import_prop_types40.default.oneOfType([import_prop_types40.default.number, import_prop_types40.default.string]).isRequired,
  selected: import_prop_types40.default.bool.isRequired,
  visibleColumns: import_prop_types40.default.arrayOf(import_prop_types40.default.object).isRequired
} : void 0;
...
function createUseGridApiEventHandler(registryContainer2) {
  ...
  return function useGridApiEventHandler2(apiRef, eventName, handler, options) {
    ...
    const [objectRetainedByReact] = React58.useState(new ObjectToBeRetainedByReact());
    const subscription = React58.useRef(null);
    const handlerRef = React58.useRef();
    handlerRef.current = handler;
    const cleanupTokenRef = React58.useRef(null);
...
function GridScrollAreaRaw(props) {
  ...
  const apiRef = useGridApiContext();
  const timeout = React59.useRef();
  const [dragging, setDragging] = React59.useState(false);
  const height = useGridSelector(apiRef, gridDensityHeaderHeightSelector);
  const scrollPosition = React59.useRef({
    left: 0,
    top: 0
  });
  const rootProps = useGridRootProps();
  ...
  const handleScrolling = React59.useCallback((newScrollPosition) => {
    scrollPosition.current = newScrollPosition;
  }, []);
  const handleDragOver = React59.useCallback((event) => {
    let offset;
  ...
  const toggleDragging = React59.useCallback(() => {
    setDragging((prevDragging) => !prevDragging);
  }, []);
  useGridApiEventHandler(apiRef, "rowsScroll", handleScrolling);
  useGridApiEventHandler(apiRef, "columnHeaderDragStart", toggleDragging);
  useGridApiEventHandler(apiRef, "columnHeaderDragEnd", toggleDragging);
  return dragging ? (0, import_jsx_runtime71.jsx)(GridScrollAreaRawRoot, {
    ref: rootRef,
...
true ? GridScrollAreaRaw.propTypes = {
  ...
  // | To update them edit the TypeScript types and run "yarn proptypes"  |
  // ----------------------------------------------------------------------
  scrollDirection: import_prop_types41.default.oneOf(["left", "right"]).isRequired
} : void 0;
var GridScrollArea = React59.memo(GridScrollAreaRaw);
...
var GridContextProvider = ({
  ...
  return (0, import_jsx_runtime72.jsx)(GridRootPropsContext.Provider, {
    value: props,
    children: (0, import_jsx_runtime72.jsx)(GridApiContext.Provider, {
      value: apiRef,
      children
    })
  });
...
var useGridLoggerFactory = (apiRef, props) => {
  apiRef.current.getLogger = React61.useCallback((name) => {
    if (forceDebug) {
...
function useGridApiInitialization(inputApiRef, props) {
  ...
  React63.useImperativeHandle(inputApiRef, () => apiRef.current, [apiRef]);
  const publishEvent = React63.useCallback((...args) => {
  ...
  const subscribeEvent = React63.useCallback((event, handler, options) => {
  ...
  const showError = React63.useCallback((args) => {
...
function useGridErrorHandler(apiRef, props) {
  const handleError = React64.useCallback((args) => {
...
var useGridLocaleText = (apiRef, props) => {
  const getLocaleText = React65.useCallback((key) => {
...
var useGridPipeProcessing = (apiRef) => {
  const processorsCache = React66.useRef({});
  const runAppliers = React66.useCallback((groupCache) => {
    if (!groupCache) {
      return;
    }
  ...
  const registerPipeProcessor = React66.useCallback((group, id, processor) => {
  ...
  const registerPipeApplier = React66.useCallback((group, id, applier) => {
    if (!processorsCache.current[group]) {
      processorsCache.current[group] = {
        processors: /* @__PURE__ */ new Map(),
        appliers: {}
  ...
  const requestPipeProcessorsApplication = React66.useCallback((group) => {
    const groupCache = processorsCache.current[group];
    runAppliers(groupCache);
  }, [runAppliers]);
  const applyPipeProcessors = React66.useCallback((...args) => {
...
var useFirstRender = (callback) => {
  const isFirstRender = React67.useRef(true);
...
var useGridRegisterPipeProcessor = (apiRef, group, callback) => {
  const cleanup = React68.useRef();
  const id = React68.useRef(`mui-${Math.round(Math.random() * 1e9)}`);
  const registerPreProcessor = React68.useCallback(() => {
...
var useGridRegisterPipeApplier = (apiRef, group, callback) => {
  const cleanup = React69.useRef();
  const id = React69.useRef(`mui-${Math.round(Math.random() * 1e9)}`);
  const registerPreProcessor = React69.useCallback(() => {
    cleanup.current = apiRef.current.unstable_registerPipeApplier(group, id.current, callback);
  }, [apiRef, callback, group]);
  useFirstRender(() => {
    registerPreProcessor();
  });
  const isFirstRender = React69.useRef(true);
  React69.useEffect(() => {
    if (isFirstRender.current) {
      isFirstRender.current = false;
    } else {
...
var useGridRegisterStrategyProcessor = (apiRef, strategyName, group, processor) => {
  const registerPreProcessor = React70.useCallback(() => {
    apiRef.current.unstable_registerStrategyProcessor(strategyName, group, processor);
  }, [apiRef, processor, group, strategyName]);
  useFirstRender(() => {
    registerPreProcessor();
  });
  const isFirstRender = React70.useRef(true);
  React70.useEffect(() => {
    if (isFirstRender.current) {
      isFirstRender.current = false;
    } else {
...
var useGridStrategyProcessing = (apiRef) => {
  const availableStrategies = React71.useRef(/* @__PURE__ */ new Map());
  const strategiesCache = React71.useRef({});
  const registerStrategyProcessor = React71.useCallback((strategyName, processorName, processor) => {
    const cleanup = () => {
  ...
  const applyStrategyProcessor = React71.useCallback((processorName, params) => {
  ...
  const getActiveStrategy = React71.useCallback((strategyGroup) => {
  ...
  const setStrategyAvailability = React71.useCallback((strategyGroup, strategyName, isAvailable) => {
...
function useGridScrollFn(apiRef, renderingZoneElementRef, columnHeadersElementRef) {
  ...
  const previousValue = React72.useRef();
  const scrollTo = React72.useCallback((v) => {
...
var useGridNativeEventListener = (apiRef, ref, eventName, handler, options) => {
  ...
  const [added, setAdded] = React73.useState(false);
  const handlerRef = React73.useRef(handler);
  const wrapHandler = React73.useCallback((event) => {
...
// node_modules/@mui/x-data-grid/hooks/core/useGridStateInitialization.js
var _excluded35 = ["stateId"];
var useGridStateInitialization = (apiRef, props) => {
  const controlStateMapRef = React74.useRef({});
  const [, rawForceUpdate] = React74.useState();
  const registerControlState = React74.useCallback((controlStateItem) => {
    const {
      stateId
    } = controlStateItem, others = _objectWithoutPropertiesLoose(controlStateItem, _excluded35);
    controlStateMapRef.current[stateId] = _extends({}, others, {
      stateId
    });
  }, []);
  const setState = React74.useCallback((state, reason) => {
    let newState;
    if (isFunction(state)) {
  ...
  const updateControlState = React74.useCallback((key, state, reason) => {
  ...
  const forceUpdate = React74.useCallback(() => rawForceUpdate(() => apiRef.current.state), [apiRef]);
  const stateApi = {
    setState,
    forceUpdate,
...
var useGridInitializeState = (initializer, apiRef, props) => {
  const isInitialized = React75.useRef(false);
...
var useGridClipboard = (apiRef) => {
  const copySelectedRowsToClipboard = React76.useCallback((includeHeaders = false) => {
...
var useGridColumnMenu = (apiRef) => {
  ...
  const showColumnMenu = React77.useCallback((field) => {
  ...
  const hideColumnMenu = React77.useCallback(() => {
    const shouldUpdate = apiRef.current.setState((state) => {
  ...
  const toggleColumnMenu = React77.useCallback((field) => {
  ...
  const handleColumnHeaderFocus = React77.useCallback((params, event) => {
...
function useGridColumns(apiRef, props) {
  ...
  const columnTypes = React78.useMemo(() => computeColumnTypes(props.columnTypes), [props.columnTypes]);
  const previousColumnsProp = React78.useRef(props.columns);
  const previousColumnTypesProp = React78.useRef(columnTypes);
  ...
  const setGridColumnsState = React78.useCallback((columnsState) => {
    logger.debug("Updating columns state.");
    apiRef.current.setState(mergeColumnsState(columnsState));
    apiRef.current.forceUpdate();
    apiRef.current.publishEvent("columnsChange", columnsState.all);
  }, [logger, apiRef]);
  const getColumn = React78.useCallback((field) => gridColumnLookupSelector(apiRef)[field], [apiRef]);
  const getAllColumns = React78.useCallback(() => gridColumnDefinitionsSelector(apiRef), [apiRef]);
  const getVisibleColumns = React78.useCallback(() => gridVisibleColumnDefinitionsSelector(apiRef), [apiRef]);
  const getColumnsMeta = React78.useCallback(() => gridColumnsMetaSelector(apiRef), [apiRef]);
  const getColumnIndex = React78.useCallback((field, useVisibleColumns = true) => {
    const columns = useVisibleColumns ? gridVisibleColumnDefinitionsSelector(apiRef) : gridColumnDefinitionsSelector(apiRef);
    return columns.findIndex((col) => col.field === field);
  }, [apiRef]);
  const getColumnPosition = React78.useCallback((field) => {
    const index = getColumnIndex(field);
    return gridColumnPositionsSelector(apiRef)[index];
  }, [apiRef, getColumnIndex]);
  const setColumnVisibilityModel = React78.useCallback((model) => {
    const currentModel = gridColumnVisibilityModelSelector(apiRef);
  ...
  const updateColumns = React78.useCallback((columns) => {
    const columnsState = createColumnsState({
      apiRef,
      columnTypes,
  ...
  const updateColumn = React78.useCallback((column) => apiRef.current.updateColumns([column]), [apiRef]);
  const setColumnVisibility = React78.useCallback((field, isVisible) => {
    if (apiRef.current.unstable_caches.columns.isUsingColumnVisibilityModel) {
  ...
  const setColumnIndex = React78.useCallback((field, targetIndexPosition) => {
  ...
  const setColumnWidth = React78.useCallback((field, width) => {
  ...
  const stateExportPreProcessing = React78.useCallback((prevState, context) => {
  ...
  const stateRestorePreProcessing = React78.useCallback((params, context) => {
  ...
  const preferencePanelPreProcessing = React78.useCallback((initialValue, value) => {
    if (value === GridPreferencePanelsValue.columns) {
      var _props$componentsProp;
      const ColumnsPanel = props.components.ColumnsPanel;
      return (0, import_jsx_runtime73.jsx)(ColumnsPanel, _extends({}, (_props$componentsProp = props.componentsProps) == null ? void 0 : _props$componentsProp.columnsPanel));
    }
    return initialValue;
  ...
  const prevInnerWidth = React78.useRef(null);
  ...
  const hydrateColumns = React78.useCallback(() => {
  ...
  const isFirstRender = React78.useRef(true);
  React78.useEffect(() => {
    if (isFirstRender.current) {
      isFirstRender.current = false;
      return;
...
var gridColumnGroupsLookupSelector = createSelector(gridColumnGroupingSelector, (columnGrouping) => columnGrouping.lookup);

// node_modules/@mui/x-data-grid/hooks/features/columnGrouping/useGridColumnGrouping.js
var _excluded36 = ["groupId", "children"];
...
var createGroupLookup = (columnGroupingModel) => {
  ...
  columnGroupingModel.forEach((node) => {
    ...
    const {
      groupId,
      children
    } = node, other = _objectWithoutPropertiesLoose(node, _excluded36);
    if (!groupId) {
...
var useGridColumnGrouping = (apiRef, props) => {
  ...
  const getColumnGroupPath = React79.useCallback((field) => {
    var _columnLookup$field$g, _columnLookup$field;
    const columnLookup = gridColumnLookupSelector(apiRef);
    return (_columnLookup$field$g = (_columnLookup$field = columnLookup[field]) == null ? void 0 : _columnLookup$field.groupPath) != null ? _columnLookup$field$g : [];
  }, [apiRef]);
  const getAllGroupDetails = React79.useCallback(() => {
  ...
  const isFirstRender = React79.useRef(true);
  React79.useEffect(() => {
...
var useGridDensity = (apiRef, props) => {
  ...
  const setDensity = React80.useCallback((newDensity, newHeaderHeight = props.headerHeight, newRowHeight = props.rowHeight, newMaxDepth = maxDepth) => {
...
var useGridCsvExport = (apiRef) => {
  ...
  const getDataAsCsv = React81.useCallback((options = {}) => {
  ...
  const exportDataAsCsv = React81.useCallback((options) => {
  ...
  const addExportMenuButtons = React81.useCallback((initialValue, options) => {
    var _options$csvOptions;
    if ((_options$csvOptions = options.csvOptions) != null && _options$csvOptions.disableToolbarButton) {
      return initialValue;
    }
    return [...initialValue, {
      component: (0, import_jsx_runtime74.jsx)(GridCsvExportMenuItem, {
...
var useGridPrintExport = (apiRef, props) => {
  ...
  const doc = React82.useRef(null);
  const previousGridState = React82.useRef(null);
  const previousColumnVisibility = React82.useRef({});
  React82.useEffect(() => {
    doc.current = ownerDocument_default(apiRef.current.rootElementRef.current);
  }, [apiRef]);
  const updateGridColumnsForPrint = React82.useCallback((fields, allColumns) => new Promise((resolve) => {
  ...
  const buildPrintWindow = React82.useCallback((title) => {
  ...
  const handlePrintWindowLoad = React82.useCallback((printWindow, options) => {
...
`;
  ...
  const handlePrintWindowAfterPrint = React82.useCallback((printWindow) => {
  ...
  const exportDataAsPrint = React82.useCallback(async (options) => {
  ...
  const addExportMenuButtons = React82.useCallback((initialValue, options) => {
    var _options$printOptions;
    if ((_options$printOptions = options.printOptions) != null && _options$printOptions.disableToolbarButton) {
      return initialValue;
    }
    return [...initialValue, {
      component: (0, import_jsx_runtime75.jsx)(GridPrintExportMenuItem, {
...
init_extends();
init_objectWithoutPropertiesLoose();
var _excluded37 = ["rowsBeforePartialUpdates"];
...
var getRowsStateFromCache = ({
  ...
  const _apiRef$current$unsta = apiRef.current.unstable_caches.rows, cacheForGrouping = _objectWithoutPropertiesLoose(_apiRef$current$unsta, _excluded37);
...
var useGridFilter = (apiRef, props) => {
  ...
  const updateFilteredRows = React83.useCallback(() => {
    apiRef.current.setState((state) => {
  ...
  const applyFilters = React83.useCallback(() => {
    updateFilteredRows();
    apiRef.current.forceUpdate();
  }, [apiRef, updateFilteredRows]);
  const upsertFilterItem = React83.useCallback((item) => {
  ...
  const upsertFilterItems = React83.useCallback((items) => {
    const filterModel = gridFilterModelSelector(apiRef);
  ...
  const deleteFilterItem = React83.useCallback((itemToDelete) => {
    const filterModel = gridFilterModelSelector(apiRef);
  ...
  const showFilterPanel = React83.useCallback((targetColumnField) => {
  ...
  const hideFilterPanel = React83.useCallback(() => {
    logger.debug("Hiding filter panel");
    apiRef.current.hidePreferences();
  }, [apiRef, logger]);
  const setFilterLinkOperator = React83.useCallback((linkOperator) => {
    const filterModel = gridFilterModelSelector(apiRef);
  ...
  const setQuickFilterValues = React83.useCallback((values) => {
    const filterModel = gridFilterModelSelector(apiRef);
  ...
  const setFilterModel = React83.useCallback((model, reason) => {
  ...
  const getVisibleRowModels = React83.useCallback(() => {
  ...
  const stateExportPreProcessing = React83.useCallback((prevState, context) => {
  ...
  const stateRestorePreProcessing = React83.useCallback((params, context) => {
    var _context$stateToResto;
  ...
  const preferencePanelPreProcessing = React83.useCallback((initialValue, value) => {
    if (value === GridPreferencePanelsValue.filters) {
      var _props$componentsProp;
      const FilterPanel = props.components.FilterPanel;
      return (0, import_jsx_runtime76.jsx)(FilterPanel, _extends({}, (_props$componentsProp = props.componentsProps) == null ? void 0 : _props$componentsProp.filterPanel));
    }
    return initialValue;
  }, [props.components.FilterPanel, (_props$componentsProp2 = props.componentsProps) == null ? void 0 : _props$componentsProp2.filterPanel]);
  const flatFilteringMethod = React83.useCallback((params) => {
  ...
  const handleColumnsChange = React83.useCallback(() => {
  ...
  const handleStrategyProcessorChange = React83.useCallback((methodName) => {
...
var useGridFocus = (apiRef, props) => {
  ...
  const lastClickedCell = React84.useRef(null);
  const publishCellFocusOut = React84.useCallback((cell, event) => {
    if (cell) {
  ...
  const setCellFocus = React84.useCallback((id, field) => {
    const focusedCell = gridFocusCellSelector(apiRef);
  ...
  const setColumnHeaderFocus = React84.useCallback((field, event = {}) => {
  ...
  const moveFocusToRelativeCell = React84.useCallback((id, field, direction) => {
  ...
  const handleCellDoubleClick = React84.useCallback(({
    id,
    field
  }) => {
    apiRef.current.setCellFocus(id, field);
  }, [apiRef]);
  const handleCellKeyDown = React84.useCallback((params, event) => {
    if (event.key === "Enter" || event.key === "Tab" || isNavigationKey(event.key)) {
      return;
    }
    apiRef.current.setCellFocus(params.id, params.field);
  }, [apiRef]);
  const handleColumnHeaderFocus = React84.useCallback(({
    field
  }, event) => {
  ...
  const handleBlur = React84.useCallback(() => {
  ...
  const handleCellMouseDown = React84.useCallback((params) => {
    lastClickedCell.current = params;
  }, []);
  const handleDocumentClick = React84.useCallback((event) => {
  ...
  const handleCellModeChange = React84.useCallback((params) => {
  ...
  const handleRowSet = React84.useCallback(() => {
    const cell = gridFocusCellSelector(apiRef);
...
var useGridKeyboardNavigation = (apiRef, props) => {
  ...
  const currentPageRows = React85.useMemo(() => enrichPageRowsWithPinnedRows(apiRef, initialCurrentPageRows), [apiRef, initialCurrentPageRows]);
  const goToCell = React85.useCallback((colIndex, rowId, closestColumnToUse = "left") => {
    const visibleSortedRows = gridVisibleSortedRowEntriesSelector(apiRef);
  ...
  const goToHeader = React85.useCallback((colIndex, event) => {
  ...
  const getRowIdFromIndex = React85.useCallback((rowIndex) => {
    return currentPageRows[rowIndex].id;
  }, [currentPageRows]);
  const handleCellNavigationKeyDown = React85.useCallback((params, event) => {
  ...
  const handleColumnHeaderKeyDown = React85.useCallback((params, event) => {
  ...
  const handleCellKeyDown = React85.useCallback((params, event) => {
    if (!event.currentTarget.contains(event.target)) {
      return;
    }
...
var useGridPageSize = (apiRef, props) => {
  ...
  const setPageSize = React86.useCallback((pageSize) => {
  ...
  const stateExportPreProcessing = React86.useCallback((prevState, context) => {
  ...
  const stateRestorePreProcessing = React86.useCallback((params, context) => {
    var _context$stateToResto;
  ...
  useGridRegisterPipeProcessor(apiRef, "exportState", stateExportPreProcessing);
  useGridRegisterPipeProcessor(apiRef, "restoreState", stateRestorePreProcessing);
  const handleUpdateAutoPageSize = React86.useCallback(() => {
    const dimensions = apiRef.current.getRootDimensions();
...
var useGridPage = (apiRef, props) => {
  ...
  const setPage = React87.useCallback((page) => {
  ...
  const stateExportPreProcessing = React87.useCallback((prevState, context) => {
    var _props$initialState, _props$initialState$p;
  ...
  const stateRestorePreProcessing = React87.useCallback((params, context) => {
...
var useGridPreferencesPanel = (apiRef, props) => {
  ...
  const hideTimeout = React88.useRef();
  const immediateTimeout = React88.useRef();
  const hidePreferences = React88.useCallback(() => {
  ...
  const doNotHidePanel = React88.useCallback(() => {
    immediateTimeout.current = setTimeout(() => clearTimeout(hideTimeout.current), 0);
  }, []);
  const hidePreferencesDelayed = React88.useCallback(() => {
    hideTimeout.current = setTimeout(hidePreferences, 100);
  }, [hidePreferences]);
  const showPreferences = React88.useCallback((newValue) => {
  ...
  const stateExportPreProcessing = React88.useCallback((prevState, context) => {
  ...
  const stateRestorePreProcessing = React88.useCallback((params, context) => {
...
var useCellEditing = (apiRef, props) => {
  ...
  const setCellMode = React89.useCallback((id, field, mode) => {
  ...
  const getCellMode = React89.useCallback((id, field) => {
    const editRowsState = gridEditRowsStateSelector(apiRef.current.state);
    const isEditing = editRowsState[id] && editRowsState[id][field];
    return isEditing ? GridCellModes.Edit : GridCellModes.View;
  }, [apiRef]);
  const commitCellChange = React89.useCallback((params, event = {}) => {
  ...
  const setCellEditingEditCellValue = React89.useCallback((params) => {
  ...
  const handleCellKeyDown = React89.useCallback(async (params, event) => {
    if (event.which === 229) {
      return;
    }
    const {
  ...
  const handleCellDoubleClick = React89.useCallback((params, event) => {
  ...
  const handleCellFocusOut = useEventCallback_default2((params, event) => {
    commitPropsAndExit(params, event);
  });
  const handleColumnHeaderDragStart = useEventCallback_default2(() => {
    const cell = gridFocusCellSelector(apiRef);
    if (!cell) {
      return;
    }
  ...
  const handleCellEditStart = React89.useCallback((params, event) => {
    if (!params.isEditable) {
      return;
    }
  ...
  const handleCellEditStop = React89.useCallback((params, event) => {
  ...
  const handleCellEditCommit = React89.useCallback((params) => {
    const {
      id,
      field
    } = params;
  ...
  const handleEditCellPropsChange = React89.useCallback((params) => {
    const row = apiRef.current.getRow(params.id);
    const column = apiRef.current.getColumn(params.field);
...
var useGridRowEditing = (apiRef, props) => {
  ...
  const focusTimeout = React90.useRef(null);
  const nextFocusedCell = React90.useRef(null);
  const columns = useGridSelector(apiRef, gridColumnDefinitionsSelector);
  const buildCallback = (callback) => (...args) => {
  ...
  const setRowMode = React90.useCallback((id, mode) => {
  ...
  const getRowMode = React90.useCallback((id) => {
    if (props.editMode === GridEditModes.Cell) {
  ...
  const commitRowChange = React90.useCallback((id, event = {}) => {
    var _props$experimentalFe;
    if (props.editMode === GridEditModes.Cell) {
  ...
  const setRowEditingEditCellValue = React90.useCallback((params) => {
    const model = apiRef.current.getEditRowsModel();
  ...
  const handleCellKeyDown = React90.useCallback(async (params, event) => {
    if (event.which === 229) {
      return;
    }
    const {
  ...
  const handleCellDoubleClick = React90.useCallback((params, event) => {
    if (!params.isEditable) {
      return;
    }
    const rowParams = apiRef.current.getRowParams(params.id);
  ...
  const handleEditCellPropsChange = React90.useCallback((params) => {
    const row = apiRef.current.getRow(params.id);
    const model = apiRef.current.getEditRowsModel();
    const editRow = model[params.id];
    Object.keys(editRow).forEach(async (field) => {
  ...
  const handleRowEditStart = React90.useCallback((params) => {
    apiRef.current.setRowMode(params.id, GridRowModes.Edit);
  }, [apiRef]);
  const handleRowEditStop = React90.useCallback((params, event) => {
    apiRef.current.setRowMode(params.id, GridRowModes.View);
    if (event.key === "Enter") {
      apiRef.current.publishEvent("cellNavigationKeyDown", params, event);
    }
  }, [apiRef]);
  const handleRowEditCommit = React90.useCallback((id) => {
    const model = apiRef.current.getEditRowsModel();
  ...
  const handleCellFocusIn = React90.useCallback((params) => {
...
function useGridEditing(apiRef, props) {
  ...
  const debounceMap = React91.useRef({});
  apiRef.current.unstable_registerControlState({
    stateId: "editRows",
  ...
  const isCellEditable = React91.useCallback(
  ...
  const runPendingEditCellValueMutation = React91.useCallback((id, field) => {
    if (!debounceMap.current[id]) {
      return;
    }
    if (!field) {
  ...
  const setEditCellValue = React91.useCallback((params, event = {}) => {
  ...
  const parseValue = React91.useCallback((id, field, value) => {
    const column = apiRef.current.getColumn(field);
    return column.valueParser ? column.valueParser(value, apiRef.current.getCellParams(id, field)) : value;
  }, [apiRef]);
  const setEditCellProps = React91.useCallback((params) => {
    const {
      id,
      field,
      props: editProps
  ...
  const setEditRowsModel = React91.useCallback((model) => {
  ...
  const getEditRowsModel = React91.useCallback(() => gridEditRowsStateSelector(apiRef.current.state), [apiRef]);
  const preventTextSelection = React91.useCallback((params, event) => {
...
init_esm();
var _excluded38 = ["id", "field"];
var _excluded211 = ["id", "field"];
...
var useGridCellEditing = (apiRef, props) => {
  const [cellModesModel, setCellModesModel] = React92.useState({});
  const cellModesModelRef = React92.useRef(cellModesModel);
  const prevCellModesModel = React92.useRef({});
  const {
    processRowUpdate,
  ...
  const throwIfNotEditable = React92.useCallback((id, field) => {
    const params = apiRef.current.getCellParams(id, field);
    if (!apiRef.current.isCellEditable(params)) {
      throw new Error(`MUI: The cell with id=${id} and field=${field} is not editable.`);
    }
  }, [apiRef]);
  const throwIfNotInMode = React92.useCallback((id, field, mode) => {
    if (apiRef.current.getCellMode(id, field) !== mode) {
      throw new Error(`MUI: The cell with id=${id} and field=${field} is not in ${mode} mode.`);
    }
  }, [apiRef]);
  const handleCellDoubleClick = React92.useCallback((params, event) => {
    if (!params.isEditable) {
      return;
    }
  ...
  const handleCellFocusOut = React92.useCallback((params, event) => {
    if (params.cellMode === GridCellModes.View) {
      return;
    }
  ...
  const handleCellKeyDown = React92.useCallback((params, event) => {
    if (params.cellMode === GridCellModes.Edit) {
      if (event.which === 229) {
        return;
      }
  ...
  const handleCellEditStart = React92.useCallback((params) => {
    const {
      id,
      field,
      reason,
    ...
    if (reason === GridCellEditStartReasons.printableKeyDown) {
      if (React92.version.startsWith("18")) {
  ...
  const handleCellEditStop = React92.useCallback((params) => {
    const {
      id,
      field,
      reason
  ...
  useGridApiOptionHandler(apiRef, "cellEditStart", props.onCellEditStart);
  useGridApiOptionHandler(apiRef, "cellEditStop", props.onCellEditStop);
  const getCellMode = React92.useCallback((id, field) => {
    const editingState = gridEditRowsStateSelector(apiRef.current.state);
  ...
  const updateFieldInCellModesModel = React92.useCallback((id, field, newProps) => {
  ...
  const updateOrDeleteFieldState = React92.useCallback((id, field, newProps) => {
    apiRef.current.setState((state) => {
  ...
  const startCellEditMode = React92.useCallback((params) => {
    const {
      id,
      field
    } = params, other = _objectWithoutPropertiesLoose(params, _excluded38);
  ...
  const stopCellEditMode = React92.useCallback((params) => {
    const {
      id,
      field
    } = params, other = _objectWithoutPropertiesLoose(params, _excluded211);
  ...
  const setCellEditingEditCellValue = React92.useCallback(async (params) => {
  ...
  const getRowWithUpdatedValuesFromCellEditing = React92.useCallback((id, field) => {
    const column = apiRef.current.getColumn(field);
    const editingState = gridEditRowsStateSelector(apiRef.current.state);
    const {
      value
...
var useGridRowEditing2 = (apiRef, props) => {
  const [rowModesModel, setRowModesModel] = React93.useState({});
  const rowModesModelRef = React93.useRef(rowModesModel);
  const prevRowModesModel = React93.useRef({});
  const focusTimeout = React93.useRef(null);
  const nextFocusedCell = React93.useRef(null);
  const {
    processRowUpdate,
    onProcessRowUpdateError,
  ...
  const throwIfNotEditable = React93.useCallback((id, field) => {
    const params = apiRef.current.getCellParams(id, field);
    if (!apiRef.current.isCellEditable(params)) {
      throw new Error(`MUI: The cell with id=${id} and field=${field} is not editable.`);
    }
  }, [apiRef]);
  const throwIfNotInMode = React93.useCallback((id, mode) => {
    if (apiRef.current.getRowMode(id) !== mode) {
      throw new Error(`MUI: The row with id=${id} is not in ${mode} mode.`);
    }
  }, [apiRef]);
  const handleCellDoubleClick = React93.useCallback((params, event) => {
    if (!params.isEditable) {
      return;
    }
  ...
  const handleCellFocusIn = React93.useCallback((params) => {
    nextFocusedCell.current = params;
  }, []);
  const handleCellFocusOut = React93.useCallback((params, event) => {
    if (!params.isEditable) {
      return;
    }
  ...
  const handleCellKeyDown = React93.useCallback((params, event) => {
  ...
  const handleRowEditStart = React93.useCallback((params) => {
    const {
      id,
      field,
      reason,
    ...
    if (reason === GridRowEditStartReasons.printableKeyDown) {
      if (React93.version.startsWith("18")) {
  ...
  const handleRowEditStop = React93.useCallback((params) => {
    const {
      id,
      reason,
      field
  ...
  useGridApiOptionHandler(apiRef, "rowEditStart", props.onRowEditStart);
  useGridApiOptionHandler(apiRef, "rowEditStop", props.onRowEditStop);
  const getRowMode = React93.useCallback((id) => {
    if (props.editMode === GridEditModes.Cell) {
      return GridRowModes.View;
    }
    const editingState = gridEditRowsStateSelector(apiRef.current.state);
  ...
  const updateRowInRowModesModel = React93.useCallback((id, newProps) => {
  ...
  const updateOrDeleteRowState = React93.useCallback((id, newProps) => {
    apiRef.current.setState((state) => {
      const newEditingState = _extends({}, state.editRows);
      if (newProps !== null) {
  ...
  const updateOrDeleteFieldState = React93.useCallback((id, field, newProps) => {
    apiRef.current.setState((state) => {
      const newEditingState = _extends({}, state.editRows);
      if (newProps !== null) {
        newEditingState[id] = _extends({}, newEditingState[id], {
  ...
  const startRowEditMode = React93.useCallback((params) => {
    const {
      id
    } = params, other = _objectWithoutPropertiesLoose(params, _excluded39);
  ...
  const stopRowEditMode = React93.useCallback((params) => {
    const {
      id
  ...
  const setRowEditingEditCellValue = React93.useCallback((params) => {
    const {
      id,
      field,
      value,
  ...
  const getRowWithUpdatedValuesFromRowEditing = React93.useCallback((id) => {
    const editingState = gridEditRowsStateSelector(apiRef.current.state);
    const row = apiRef.current.getRow(id);
    let rowUpdate = _extends({}, row);
...
var useGridEditing2 = (apiRef, props) => {
  ...
  const debounceMap = React94.useRef({});
  const {
    isCellEditable: isCellEditableProp
  } = props;
  const isCellEditable = React94.useCallback((params) => {
  ...
  const runPendingEditCellValueMutation = React94.useCallback((id, field) => {
    if (!debounceMap.current[id]) {
      return;
    }
    if (!field) {
  ...
  const setEditCellValue = React94.useCallback((params) => {
    const {
      id,
      field,
      debounceMs
  ...
  const getRowWithUpdatedValues = React94.useCallback((id, field) => {
    return props.editMode === GridEditModes.Cell ? apiRef.current.unstable_getRowWithUpdatedValuesFromCellEditing(id, field) : apiRef.current.unstable_getRowWithUpdatedValuesFromRowEditing(id);
  }, [apiRef, props.editMode]);
  const getEditCellMeta = React94.useCallback((id, field) => {
    const editingState = gridEditRowsStateSelector(apiRef.current.state);
    return {
...
var useGridRows = (apiRef, props) => {
  ...
  const lastUpdateMs = React95.useRef(Date.now());
  const timeout = React95.useRef(null);
  const getRow = React95.useCallback((id) => {
    var _ref;
    return (_ref = gridRowsLookupSelector(apiRef)[id]) != null ? _ref : null;
  }, [apiRef]);
  const lookup = React95.useMemo(() => currentPage.rows.reduce((acc, {
    id
  }, index) => {
    acc[id] = index;
    return acc;
  }, {}), [currentPage.rows]);
  const throttledRowsChange = React95.useCallback((newCache, throttle) => {
    const run = () => {
  ...
  const setRows = React95.useCallback((rows) => {
  ...
  const updateRows = React95.useCallback((updates) => {
  ...
  const getRowModels = React95.useCallback(() => {
    const allRows = gridRowIdsSelector(apiRef);
    const idRowsLookup = gridRowsLookupSelector(apiRef);
    return new Map(allRows.map((id) => [id, idRowsLookup[id]]));
  }, [apiRef]);
  const getRowsCount = React95.useCallback(() => gridRowCountSelector(apiRef), [apiRef]);
  const getAllRowIds = React95.useCallback(() => gridRowIdsSelector(apiRef), [apiRef]);
  const getRowIndexRelativeToVisibleRows = React95.useCallback((id) => lookup[id], [lookup]);
  const setRowChildrenExpansion = React95.useCallback((id, isExpanded) => {
  ...
  const getRowNode = React95.useCallback((id) => {
    var _gridRowTreeSelector$;
    return (_gridRowTreeSelector$ = gridRowTreeSelector(apiRef)[id]) != null ? _gridRowTreeSelector$ : null;
  }, [apiRef]);
  const getRowGroupChildren = React95.useCallback(({
  ...
  const setRowIndex = React95.useCallback((rowId, targetIndex) => {
    const allRows = gridRowIdsSelector(apiRef);
  ...
  const replaceRows = React95.useCallback((firstRowToRender, newRows) => {
  ...
  const groupRows = React95.useCallback(() => {
  ...
  const handleStrategyActivityChange = React95.useCallback(() => {
  ...
  const applyHydrateRowsProcessor = React95.useCallback(() => {
    apiRef.current.setState((state) => _extends({}, state, {
...
function useGridParamsApi(apiRef) {
  const getColumnHeaderParams = React96.useCallback((field) => ({
    field,
    colDef: apiRef.current.getColumn(field)
  }), [apiRef]);
  const getCellValueWithDeprecationWarning = React96.useCallback((...args) => {
    if (true) {
      getCellValueWarning();
    }
    return apiRef.current.getCellValue(...args);
  }, [apiRef]);
  const getRowParams = React96.useCallback((id) => {
    const row = apiRef.current.getRow(id);
    if (!row) {
  ...
  const getBaseCellParams = React96.useCallback((id, field) => {
    const row = apiRef.current.getRow(id);
  ...
  const getCellParams = React96.useCallback((id, field) => {
  ...
  const getCellValue = React96.useCallback((id, field) => {
    const colDef = apiRef.current.getColumn(field);
    if (true) {
  ...
  const getColumnHeaderElement = React96.useCallback((field) => {
    if (!apiRef.current.rootElementRef.current) {
      return null;
    }
    return getGridColumnHeaderElement(apiRef.current.rootElementRef.current, field);
  }, [apiRef]);
  const getRowElement = React96.useCallback((id) => {
    if (!apiRef.current.rootElementRef.current) {
      return null;
    }
    return getGridRowElement(apiRef.current.rootElementRef.current, id);
  }, [apiRef]);
  const getCellElement = React96.useCallback((id, field) => {
    if (!apiRef.current.rootElementRef.current) {
      return null;
    }
...
var useGridSelection = (apiRef, props) => {
  ...
  const propSelectionModel = React97.useMemo(() => {
    return getSelectionModelPropValue(props.selectionModel, gridSelectionStateSelector(apiRef.current.state));
  }, [apiRef, props.selectionModel]);
  const lastRowToggled = React97.useRef(null);
  apiRef.current.unstable_registerControlState({
    stateId: "selection",
  ...
  const expandMouseRowRangeSelection = React97.useCallback((id) => {
  ...
  const setSelectionModel = React97.useCallback((model) => {
  ...
  const isRowSelected = React97.useCallback((id) => gridSelectionStateSelector(apiRef.current.state).includes(id), [apiRef]);
  const isRowSelectable = React97.useCallback((id) => {
  ...
  const getSelectedRows = React97.useCallback(() => selectedGridRowsSelector(apiRef), [apiRef]);
  const selectRow = React97.useCallback((id, isSelected = true, resetSelection = false) => {
  ...
  const selectRows = React97.useCallback((ids, isSelected = true, resetSelection = false) => {
  ...
  const selectRowRange = React97.useCallback(({
    startId,
    endId
  ...
  const removeOutdatedSelection = React97.useCallback(() => {
  ...
  const handleSingleRowSelection = React97.useCallback((id, event) => {
  ...
  const handleRowClick = React97.useCallback((params, event) => {
    var _closest;
  ...
  const preventSelectionOnShift = React97.useCallback((params, event) => {
    if (canHaveMultipleSelection && event.shiftKey) {
      var _window$getSelection;
      (_window$getSelection = window.getSelection()) == null ? void 0 : _window$getSelection.removeAllRanges();
    }
  }, [canHaveMultipleSelection]);
  const handleRowSelectionCheckboxChange = React97.useCallback((params, event) => {
  ...
  const handleHeaderSelectionCheckboxChange = React97.useCallback((params) => {
...
var _excluded40 = ["sortingOrder"];
var GridColumnUnsortedIcon = React98.memo(function GridColumnHeaderSortIcon2(props) {
  const {
    sortingOrder
  ...
  return Icon ? (0, import_jsx_runtime77.jsx)(Icon, _extends({}, other)) : null;
});
...
var _excluded41 = ["error", "hasError", "errorInfo"];
var ErrorOverlay = React99.forwardRef(function ErrorOverlay2(props, ref) {
  const {
    error
  ...
  const rowHeight = useGridSelector(apiRef, gridDensityRowHeightSelector);
  return (0, import_jsx_runtime78.jsx)(GridOverlay, _extends({
    ref,
    sx: {
      width: "100%",
...
var GridNoResultsOverlay = React100.forwardRef(function GridNoResultsOverlay2(props, ref) {
  const apiRef = useGridApiContext();
  const noResultsOverlayLabel = apiRef.current.getLocaleText("noResultsOverlayLabel");
  return (0, import_jsx_runtime79.jsx)(GridOverlay, _extends({
    ref
  }, props, {
...
var useGridSelectionPreProcessors = (apiRef, props) => {
  ...
  const updateSelectionColumn = React101.useCallback((columnsState) => {
...
var useGridSorting = (apiRef, props) => {
  ...
  const upsertSortModel = React102.useCallback((field, sortItem) => {
  ...
  const createSortItem = React102.useCallback((col, directionOverride) => {
  ...
  const applySorting = React102.useCallback(() => {
    apiRef.current.setState((state) => {
  ...
  const setSortModel = React102.useCallback((model) => {
  ...
  const sortColumn = React102.useCallback((column, direction, allowMultipleSorting) => {
    if (!column.sortable) {
      return;
    }
  ...
  const getSortModel = React102.useCallback(() => gridSortModelSelector(apiRef), [apiRef]);
  const getSortedRows = React102.useCallback(() => {
    const sortedRows = gridSortedRowEntriesSelector(apiRef);
    return sortedRows.map((row) => row.model);
  }, [apiRef]);
  const getSortedRowIds = React102.useCallback(() => gridSortedRowIdsSelector(apiRef), [apiRef]);
  const getRowIndex = React102.useCallback((id) => apiRef.current.getSortedRowIds().indexOf(id), [apiRef]);
  const getRowIdFromRowIndex = React102.useCallback((index) => apiRef.current.getSortedRowIds()[index], [apiRef]);
  const sortApi = {
    getSortModel,
    getSortedRows,
    getSortedRowIds,
  ...
  const stateExportPreProcessing = React102.useCallback((prevState, context) => {
    var _props$initialState2, _props$initialState2$;
  ...
  const stateRestorePreProcessing = React102.useCallback((params, context) => {
    var _context$stateToResto;
  ...
  const flatSortingMethod = React102.useCallback((params) => {
    const rowTree = gridRowTreeSelector(apiRef);
  ...
  const handleColumnHeaderClick = React102.useCallback(({
    colDef
  }, event) => {
    const allowMultipleSorting = event.shiftKey || event.metaKey || event.ctrlKey;
    sortColumn(colDef, void 0, allowMultipleSorting);
  }, [sortColumn]);
  const handleColumnHeaderKeyDown = React102.useCallback(({
    colDef
  }, event) => {
  ...
  const handleColumnsChange = React102.useCallback(() => {
    const sortModel = gridSortModelSelector(apiRef);
  ...
  const handleStrategyProcessorChange = React102.useCallback((methodName) => {
...
var useGridScroll = (apiRef, props) => {
  ...
  const scrollToIndexes = React103.useCallback((params) => {
  ...
  const scroll = React103.useCallback((params) => {
  ...
  const getScrollPosition = React103.useCallback(() => {
...
function useGridDimensions(apiRef, props) {
  ...
  const errorShown = React104.useRef(false);
  const rootDimensionsRef = React104.useRef(null);
  const fullDimensionsRef = React104.useRef(null);
  const rowsMeta = useGridSelector(apiRef, gridRowsMetaSelector);
  const totalHeaderHeight = useGridSelector(apiRef, gridDensityTotalHeaderHeightSelector);
  const updateGridDimensionsRef = React104.useCallback(() => {
  ...
  const resize = React104.useCallback(() => {
    updateGridDimensionsRef();
    apiRef.current.publishEvent("debouncedResize", rootDimensionsRef.current);
  }, [apiRef, updateGridDimensionsRef]);
  const getRootDimensions = React104.useCallback(() => fullDimensionsRef.current, []);
  const getViewportPageSize = React104.useCallback(() => {
    const dimensions = apiRef.current.getRootDimensions();
    if (!dimensions) {
      return 0;
    }
  ...
  const debounceResize = React104.useMemo(() => debounce_default(resize, 60), [resize]);
  const isFirstSizing = React104.useRef(true);
  const handleResize = React104.useCallback((size) => {
...
var useGridRowsMeta = (apiRef, props) => {
  ...
  const rowsHeightLookup = React105.useRef({});
  const lastMeasuredRowIndex = React105.useRef(-1);
  const hasRowWithAutoHeight = React105.useRef(false);
  ...
  const hydrateRowsMeta = React105.useCallback(() => {
    var _pinnedRows$top, _pinnedRows$bottom;
  ...
  const getRowHeight = React105.useCallback((rowId) => {
  ...
  const setRowHeight = React105.useCallback((id, height) => {
    rowsHeightLookup.current[id].sizes.baseCenter = height;
    rowsHeightLookup.current[id].isResized = true;
    rowsHeightLookup.current[id].needsFirstMeasurement = false;
    hydrateRowsMeta();
  }, [hydrateRowsMeta]);
  const debouncedHydrateRowsMeta = React105.useMemo(() => debounce_default(hydrateRowsMeta), [hydrateRowsMeta]);
  const storeMeasuredRowHeight = React105.useCallback((id, height, position) => {
  ...
  const rowHasAutoHeight = React105.useCallback((id) => {
    var _rowsHeightLookup$cur2;
    return ((_rowsHeightLookup$cur2 = rowsHeightLookup.current[id]) == null ? void 0 : _rowsHeightLookup$cur2.autoHeight) || false;
  }, []);
  const getLastMeasuredRowIndex = React105.useCallback(() => {
    return lastMeasuredRowIndex.current;
  }, []);
  const setLastMeasuredRowIndex = React105.useCallback((index) => {
    if (hasRowWithAutoHeight.current && index > lastMeasuredRowIndex.current) {
      lastMeasuredRowIndex.current = index;
    }
  }, []);
  const resetRowHeights = React105.useCallback(() => {
...
var useGridStatePersistence = (apiRef) => {
  const exportState = React106.useCallback((params = {}) => {
    const stateToExport = apiRef.current.unstable_applyPipeProcessors("exportState", {}, params);
    return stateToExport;
  }, [apiRef]);
  const restoreState = React106.useCallback((stateToRestore) => {
...
var useGridColumnSpanning = (apiRef) => {
  const lookup = React107.useRef({});
  const setCellColSpanInfo = React107.useCallback((rowId, columnIndex, cellColSpanInfo) => {
  ...
  const getCellColSpanInfo = React107.useCallback((rowId, columnIndex) => {
    var _lookup$current$rowId;
    return (_lookup$current$rowId = lookup.current[rowId]) == null ? void 0 : _lookup$current$rowId[columnIndex];
  }, []);
  const calculateCellColSpan = React107.useCallback((params) => {
    const {
      columnIndex,
      rowId,
      minFirstColumnIndex,
  ...
  const calculateColSpan = React107.useCallback(({
    rowId,
    minFirstColumn,
    maxLastColumn,
    columns
  ...
  const handleColumnReorderChange = React107.useCallback(() => {
    lookup.current = {};
  }, []);
...
var useGridColumnGroupingPreProcessors = (apiRef, props) => {
  var _props$experimentalFe2;
  const addHeaderGroups = React108.useCallback((columnsState) => {
    var _props$experimentalFe;
    if (!((_props$experimentalFe = props.experimentalFeatures) != null && _props$experimentalFe.columnGrouping)) {
      return columnsState;
    }
...
var useDataGridProps = (inProps) => {
  ...
  const localeText = React109.useMemo(() => _extends({}, GRID_DEFAULT_LOCALE_TEXT, themedProps.localeText), [themedProps.localeText]);
  const components = React109.useMemo(() => {
  ...
  return React109.useMemo(() => _extends({}, DATA_GRID_PROPS_DEFAULT_VALUES, themedProps, {
    localeText,
    components
...
var GridVirtualScroller = React110.forwardRef(function GridVirtualScroller2(props, ref) {
  const {
    className
  } = props, other = _objectWithoutPropertiesLoose(props, _excluded42);
  const rootProps = useGridRootProps();
  const classes = useUtilityClasses27(rootProps);
  return (0, import_jsx_runtime80.jsx)(VirtualScrollerRoot, _extends({
    ref,
    className: clsx_m_default(classes.root, className),
    ownerState: rootProps
  }, other));
...
var _excluded43 = ["className", "style"];
...
var GridVirtualScrollerContent = React111.forwardRef(function GridVirtualScrollerContent2(props, ref) {
  const {
    className,
    style
  ...
  return (0, import_jsx_runtime81.jsx)(VirtualScrollerContentRoot, _extends({
    ref,
    className: clsx_m_default(classes.root, className),
    ownerState,
    style
...
var GridVirtualScrollerRenderZone = React112.forwardRef(function GridVirtualScrollerRenderZone2(props, ref) {
  const {
    className
  } = props, other = _objectWithoutPropertiesLoose(props, _excluded44);
  const rootProps = useGridRootProps();
  const classes = useUtilityClasses29(rootProps);
  return (0, import_jsx_runtime82.jsx)(VirtualScrollerRenderZoneRoot, _extends({
    ref,
    className: clsx_m_default(classes.root, className),
    ownerState: rootProps
  }, other));
...
var useGridVirtualScroller = (props) => {
  ...
  const currentPage = useGridVisibleRows(apiRef, rootProps);
  const renderZoneRef = React113.useRef(null);
  const rootRef = React113.useRef(null);
  const handleRef = useForkRef_default(ref, rootRef);
  const [renderContext, setRenderContext] = React113.useState(null);
  const prevRenderContext = React113.useRef(renderContext);
  const scrollPosition = React113.useRef({
    top: 0,
    left: 0
  });
  const [containerDimensions, setContainerDimensions] = React113.useState({
    width: null,
    height: null
  });
  const prevTotalWidth = React113.useRef(columnsTotalWidth);
  const getNearestIndexToRender = React113.useCallback((offset) => {
  ...
  const computeRenderContext = React113.useCallback(() => {
  ...
  const handleResize = React113.useCallback((params) => {
    setContainerDimensions({
      width: params.width,
  ...
  useGridApiEventHandler(apiRef, "resize", handleResize);
  const updateRenderZonePosition = React113.useCallback((nextRenderContext) => {
    const [firstRowToRender, lastRowToRender] = getRenderableIndexes({
  ...
  const updateRenderContext = React113.useCallback((nextRenderContext) => {
  ...
  const getRows = (params = {
    ...
    for (let i = 0; i < renderedRows.length; i += 1) {
      ...
      rows.push((0, import_jsx_runtime83.jsx)(rootProps.components.Row, _extends({
        row: model,
        rowId: id,
  ...
  const contentSize = React113.useMemo(() => {
  ...
  const getRenderContext = React113.useCallback(() => {
  ...
  return {
    ...
    getRootProps: (_ref = {}) => {
      let {
        style = {}
      } = _ref, other = _objectWithoutPropertiesLoose(_ref, _excluded45);
      return _extends({
        ref: handleRef,
...
var _excluded46 = ["className", "disableVirtualization"];
var DataGridVirtualScroller = React114.forwardRef(function DataGridVirtualScroller2(props, ref) {
  const {
    className,
    disableVirtualization
  ...
  return (0, import_jsx_runtime84.jsx)(GridVirtualScroller, _extends({
    className
  }, getRootProps(other), {
    children: (0, import_jsx_runtime84.jsx)(GridVirtualScrollerContent, _extends({}, getContentProps(), {
      children: (0, import_jsx_runtime84.jsx)(GridVirtualScrollerRenderZone, _extends({}, getRenderZoneProps(), {
        children: getRows()
      }))
    }))
  }));
...
function GridColumnGroupHeader(props) {
  ...
  return (0, import_jsx_runtime85.jsx)(GridGenericColumnHeaderItem, {
    classes,
...
var useGridColumnHeaders = (props) => {
  ...
  const [dragCol, setDragCol] = React116.useState("");
  const [resizeCol, setResizeCol] = React116.useState("");
  const apiRef = useGridApiContext();
  const visibleColumns = useGridSelector(apiRef, gridVisibleColumnDefinitionsSelector);
  const columnPositions = useGridSelector(apiRef, gridColumnPositionsSelector);
  ...
  const rootProps = useGridRootProps();
  const innerRef = React116.useRef(null);
  const handleInnerRef = useForkRef_default(innerRefProp, innerRef);
  const [renderContext, setRenderContext] = React116.useState(null);
  const prevRenderContext = React116.useRef(renderContext);
  const prevScrollLeft = React116.useRef(0);
  const currentPage = useGridVisibleRows(apiRef, rootProps);
  React116.useEffect(() => {
    apiRef.current.columnHeadersContainerElementRef.current.scrollLeft = 0;
  }, [apiRef]);
  const getFirstColumnIndexToRenderRef = React116.useRef(defaultMemoize(getFirstColumnIndexToRender, {
    equalityCheck: (a, b) => ["firstColumnIndex", "minColumnIndex", "columnBuffer"].every((key) => a[key] === b[key])
  }));
  const updateInnerPosition = React116.useCallback((nextRenderContext) => {
    const [firstRowToRender, lastRowToRender] = getRenderableIndexes({
      firstIndex: nextRenderContext.firstRowIndex,
      lastIndex: nextRenderContext.lastRowIndex,
      minFirstIndex: 0,
  ...
  const handleScroll = React116.useCallback(({
    left,
  ...
  const handleColumnResizeStart = React116.useCallback((params) => setResizeCol(params.field), []);
  const handleColumnResizeStop = React116.useCallback(() => setResizeCol(""), []);
  const handleColumnReorderStart = React116.useCallback((params) => setDragCol(params.field), []);
  const handleColumnReorderStop = React116.useCallback(() => setDragCol(""), []);
  ...
  const getColumnHeaders = (params, other = {}) => {
    ...
    for (let i = 0; i < renderedColumns.length; i += 1) {
      ...
      columns.push((0, import_jsx_runtime86.jsx)(GridColumnHeaderItem, _extends({}, sortColumnLookup[column.field], {
        columnMenuOpen: open,
    ...
    return (0, import_jsx_runtime86.jsx)(GridColumnHeaderRow, {
      role: "row",
  ...
  const getColumnGroupHeaders = (params) => {
    ...
    headerToRender.forEach((depthInfo, depthIndex) => {
      columns.push((0, import_jsx_runtime86.jsx)(GridColumnHeaderRow, {
        style: {
...
var GridColumnHeaders = React117.forwardRef(function GridColumnHeaders2(props, ref) {
  const {
    className
  } = props, other = _objectWithoutPropertiesLoose(props, _excluded47);
  const rootProps = useGridRootProps();
  const classes = useUtilityClasses31(rootProps);
...
var _excluded48 = ["isDragging", "className"];
...
var GridColumnHeadersInner = React118.forwardRef(function GridColumnHeadersInner2(props, ref) {
  var _apiRef$current$getRo, _apiRef$current$getRo2;
  const {
    isDragging,
    className
  ...
  return (0, import_jsx_runtime88.jsx)(GridColumnHeadersInnerRoot, _extends({
    ref,
    className: clsx_m_default(className, classes.root),
    ownerState
  }, other));
...
var _excluded49 = ["innerRef", "className"];
var DataGridColumnHeaders = React119.forwardRef(function GridColumnsHeader(props, ref) {
  const {
    innerRef
  ...
  return (0, import_jsx_runtime90.jsxs)(GridColumnHeaders, _extends({
    ref
  }, getRootProps(other), {
    children: [(0, import_jsx_runtime89.jsx)(GridScrollArea, {
      scrollDirection: "left"
    }), (0, import_jsx_runtime90.jsxs)(GridColumnHeadersInner, _extends({
      isDragging
    }, getInnerProps(), {
      children: [getColumnGroupHeaders(), getColumnHeaders()]
    })), (0, import_jsx_runtime89.jsx)(GridScrollArea, {
...
var DataGridRaw = React120.forwardRef(function DataGrid(inProps, ref) {
  const props = useDataGridProps(inProps);
  const apiRef = useDataGridComponent(props);
  return (0, import_jsx_runtime91.jsx)(GridContextProvider, {
    apiRef,
    props,
    children: (0, import_jsx_runtime91.jsx)(GridRoot, {
      className: props.className,
      style: props.style,
      sx: props.sx,
      ref,
      children: (0, import_jsx_runtime92.jsxs)(GridErrorHandler, {
        children: [(0, import_jsx_runtime91.jsx)(GridHeaderPlaceholder, {}), (0, import_jsx_runtime91.jsx)(GridBody, {
          ColumnHeadersComponent: DataGridColumnHeaders,
          VirtualScrollerComponent: DataGridVirtualScroller
        }), (0, import_jsx_runtime91.jsx)(GridFooterPlaceholder, {})]
      })
    })
  });
});
var DataGrid2 = React120.memo(DataGridRaw);
DataGridRaw.propTypes = {
   ...
   * @default false
   */
  autoHeight: import_prop_types42.default.bool,
  /**
   * If `true`, the pageSize is calculated according to the container size and the max number of rows to avoid rendering a vertical scroll bar.
   * @default false
   */
  autoPageSize: import_prop_types42.default.bool,
  /**
   * Controls the modes of the cells.
   */
  cellModesModel: import_prop_types42.default.object,
  /**
   * If `true`, the grid get a first column with a checkbox that allows to select rows.
   * @default false
   */
  checkboxSelection: import_prop_types42.default.bool,
  /**
   * Override or extend the styles applied to the component.
   */
   ...
   * @default 3
   */
  columnBuffer: import_prop_types42.default.number,
  columnGroupingModel: import_prop_types42.default.arrayOf(import_prop_types42.default.object),
  /**
   * Set of columns of type [[GridColumns]].
   */
  columns: chainPropTypes(import_prop_types42.default.array.isRequired, (props) => {
   ...
   * @default 3
   */
  columnThreshold: import_prop_types42.default.number,
  /**
   * Extend native column types with your new column types.
   */
  columnTypes: import_prop_types42.default.object,
  /**
   * Set the column visibility model of the grid.
   * If defined, the grid will ignore the `hide` property in [[GridColDef]].
   */
  columnVisibilityModel: import_prop_types42.default.object,
  /**
   * Overrideable components.
   */
  components: import_prop_types42.default.object,
  /**
   ...
   * @default "standard"
   */
  density: import_prop_types42.default.oneOf(["comfortable", "compact", "standard"]),
  /**
   * If `true`, column filters are disabled.
   * @default false
   */
  disableColumnFilter: import_prop_types42.default.bool,
  /**
   * If `true`, the column menu is disabled.
   * @default false
   */
  disableColumnMenu: import_prop_types42.default.bool,
  /**
   * If `true`, hiding/showing columns is disabled.
   * @default false
   */
  disableColumnSelector: import_prop_types42.default.bool,
  /**
   * If `true`, the density selector is disabled.
   * @default false
   */
  disableDensitySelector: import_prop_types42.default.bool,
  /**
   * If `true`, rows will not be extended to fill the full width of the grid container.
   * @default false
   */
  disableExtendRowFullWidth: import_prop_types42.default.bool,
  /**
   * If `true`, modification to a cell will not be discarded if the mode is changed from "edit" to "view" while processing props.
   * @default false
   */
  disableIgnoreModificationsIfProcessingProps: import_prop_types42.default.bool,
  /**
   * If `true`, the selection on click on a row or cell is disabled.
   * @default false
   */
  disableSelectionOnClick: import_prop_types42.default.bool,
  /**
   * If `true`, the virtualization is disabled.
   * @default false
   */
  disableVirtualization: import_prop_types42.default.bool,
  /**
   * Controls whether to use the cell or row editing.
   * @default "cell"
   */
  editMode: import_prop_types42.default.oneOf(["cell", "row"]),
  /**
   * Set the edit rows model of the grid.
   */
  editRowsModel: import_prop_types42.default.object,
  /**
   * An error that will turn the grid into its error state and display the error component.
   */
  error: import_prop_types42.default.any,
  /**
   * Features under development.
   * For each feature, if the flag is not explicitly set to `true`, the feature will be fully disabled and any property / method call will not have any effect.
   */
  experimentalFeatures: import_prop_types42.default.shape({
    columnGrouping: import_prop_types42.default.bool,
    newEditingApi: import_prop_types42.default.bool,
    preventCommitWhileValidating: import_prop_types42.default.bool,
    warnIfFocusStateIsNotSynced: import_prop_types42.default.bool
  }),
  /**
   ...
   * @default "client"
   */
  filterMode: import_prop_types42.default.oneOf(["client", "server"]),
  /**
   * Set the filter model of the grid.
   */
  filterModel: import_prop_types42.default.shape({
    items: import_prop_types42.default.arrayOf(import_prop_types42.default.shape({
      columnField: import_prop_types42.default.string.isRequired,
      id: import_prop_types42.default.oneOfType([import_prop_types42.default.number, import_prop_types42.default.string]),
      operatorValue: import_prop_types42.default.string,
      value: import_prop_types42.default.any
    })).isRequired,
    linkOperator: import_prop_types42.default.oneOf(["and", "or"]),
    quickFilterLogicOperator: import_prop_types42.default.oneOf(["and", "or"]),
    quickFilterValues: import_prop_types42.default.array
  }),
  /**
   ...
   */
  getCellClassName: import_prop_types42.default.func,
  /**
   * Function that returns the element to render in row detail.
   * @param {GridRowParams} params With all properties from [[GridRowParams]].
   * @returns {JSX.Element} The row detail element.
   */
  getDetailPanelContent: import_prop_types42.default.func,
  /**
   ...
   */
  getEstimatedRowHeight: import_prop_types42.default.func,
  /**
   * Function that applies CSS classes dynamically on rows.
   * @param {GridRowClassNameParams} params With all properties from [[GridRowClassNameParams]].
   * @returns {string} The CSS class to apply to the row.
   */
  getRowClassName: import_prop_types42.default.func,
  /**
   * Function that sets the row height per row.
   * @param {GridRowHeightParams} params With all properties from [[GridRowHeightParams]].
   * @returns {GridRowHeightReturnValue} The row height value. If `null` or `undefined` then the default row height is applied. If "auto" then the row height is calculated based on the content.
   */
  getRowHeight: import_prop_types42.default.func,
  /**
   * Return the id of a given [[GridRowModel]].
   */
  getRowId: import_prop_types42.default.func,
  /**
   * Function that allows to specify the spacing between rows.
   * @param {GridRowSpacingParams} params With all properties from [[GridRowSpacingParams]].
   * @returns {GridRowSpacing} The row spacing values.
   */
  getRowSpacing: import_prop_types42.default.func,
  /**
   * Set the height in pixel of the column headers in the grid.
   * @default 56
   */
  headerHeight: import_prop_types42.default.number,
  /**
   * If `true`, the footer component is hidden.
   * @default false
   */
  hideFooter: import_prop_types42.default.bool,
  /**
   * If `true`, the pagination component in the footer is hidden.
   * @default false
   */
  hideFooterPagination: import_prop_types42.default.bool,
  /**
   * If `true`, the selected row count in the footer is hidden.
   * @default false
   */
  hideFooterSelectedRowCount: import_prop_types42.default.bool,
  /**
   * The initial state of the DataGrid.
   * The data in it will be set in the state on initialization but will not be controlled.
   * If one of the data in `initialState` is also being controlled, then the control state wins.
   */
  initialState: import_prop_types42.default.object,
  /**
   * Callback fired when a cell is rendered, returns true if the cell is editable.
   * @param {GridCellParams} params With all properties from [[GridCellParams]].
   * @returns {boolean} A boolean indicating if the cell is editable.
   */
  isCellEditable: import_prop_types42.default.func,
  /**
   * Determines if a row can be selected.
   * @param {GridRowParams} params With all properties from [[GridRowParams]].
   * @returns {boolean} A boolean indicating if the cell is selectable.
   */
  isRowSelectable: import_prop_types42.default.func,
  /**
   ...
   * @default false
   */
  keepNonExistentRowsSelected: import_prop_types42.default.bool,
  /**
   ...
   */
  localeText: import_prop_types42.default.object,
  /**
   * Pass a custom logger in the components that implements the [[Logger]] interface.
   * @default console
   */
  logger: import_prop_types42.default.shape({
    debug: import_prop_types42.default.func.isRequired,
    error: import_prop_types42.default.func.isRequired,
    info: import_prop_types42.default.func.isRequired,
    warn: import_prop_types42.default.func.isRequired
  }),
  /**
   * Allows to pass the logging level or false to turn off logging.
   * @default "error" ("warn" in dev mode)
   */
  logLevel: import_prop_types42.default.oneOf(["debug", "error", "info", "warn", false]),
  /**
   * Nonce of the inline styles for [Content Security Policy](https://www.w3.org/TR/2016/REC-CSP2-20161215/#script-src-the-nonce-attribute).
   */
  nonce: import_prop_types42.default.string,
  /**
   ...
   */
  onCellClick: import_prop_types42.default.func,
  /**
   ...
   * @param {GridCallbackDetails} details Additional details for this callback.
   */
  onCellDoubleClick: import_prop_types42.default.func,
  /**
   ...
   * @param {GridCallbackDetails} details Additional details for this callback.
   */
  onCellEditCommit: import_prop_types42.default.func,
  /**
   * Callback fired when the cell turns to edit mode.
   * @param {GridCellParams} params With all properties from [[GridCellParams]].
   * @param {MuiEvent<React.KeyboardEvent | React.MouseEvent>} event The event that caused this prop to be called.
   */
  onCellEditStart: import_prop_types42.default.func,
  /**
   * Callback fired when the cell turns to view mode.
   * @param {GridCellParams} params With all properties from [[GridCellParams]].
   * @param {MuiEvent<MuiBaseEvent>} event The event that caused this prop to be called.
   */
  onCellEditStop: import_prop_types42.default.func,
  /**
   ...
   * @param {GridCallbackDetails} details Additional details for this callback.
   */
  onCellFocusOut: import_prop_types42.default.func,
  /**
   ...
   * @param {GridCallbackDetails} details Additional details for this callback.
   */
  onCellKeyDown: import_prop_types42.default.func,
  /**
   * Callback fired when the `cellModesModel` prop changes.
   * @param {GridCellModesModel} cellModesModel Object containig which cells are in "edit" mode.
   * @param {GridCallbackDetails} details Additional details for this callback.
   */
  onCellModesModelChange: import_prop_types42.default.func,
  /**
   ...
   * @param {GridCallbackDetails} details Additional details for this callback.
   */
  onColumnHeaderClick: import_prop_types42.default.func,
  /**
   ...
   * @param {GridCallbackDetails} details Additional details for this callback.
   */
  onColumnHeaderDoubleClick: import_prop_types42.default.func,
  /**
   ...
   * @param {GridCallbackDetails} details Additional details for this callback.
   */
  onColumnHeaderEnter: import_prop_types42.default.func,
  /**
   ...
   * @param {GridCallbackDetails} details Additional details for this callback.
   */
  onColumnHeaderLeave: import_prop_types42.default.func,
  /**
   ...
   * @param {GridCallbackDetails} details Additional details for this callback.
   */
  onColumnHeaderOut: import_prop_types42.default.func,
  /**
   ...
   * @param {GridCallbackDetails} details Additional details for this callback.
   */
  onColumnHeaderOver: import_prop_types42.default.func,
  /**
   ...
   * @param {GridCallbackDetails} details Additional details for this callback.
   */
  onColumnOrderChange: import_prop_types42.default.func,
  /**
   ...
   */
  onColumnVisibilityChange: import_prop_types42.default.func,
  /**
   * Callback fired when the column visibility model changes.
   * @param {GridColumnVisibilityModel} model The new model.
   * @param {GridCallbackDetails} details Additional details for this callback.
   */
  onColumnVisibilityModelChange: import_prop_types42.default.func,
  /**
   ...
   */
  onEditCellPropsChange: import_prop_types42.default.func,
  /**
   * Callback fired when the `editRowsModel` changes.
   * @param {GridEditRowsModel} editRowsModel With all properties from [[GridEditRowsModel]].
   * @param {GridCallbackDetails} details Additional details for this callback.
   */
  onEditRowsModelChange: import_prop_types42.default.func,
  /**
   ...
   * @param {GridCallbackDetails} details Additional details for this callback.
   */
  onError: import_prop_types42.default.func,
  /**
   * Callback fired when the Filter model changes before the filters are applied.
   * @param {GridFilterModel} model With all properties from [[GridFilterModel]].
   * @param {GridCallbackDetails} details Additional details for this callback.
   */
  onFilterModelChange: import_prop_types42.default.func,
  /**
   ...
   * @param {GridCallbackDetails} details Additional details for this callback.
   */
  onMenuClose: import_prop_types42.default.func,
  /**
   ...
   * @param {GridCallbackDetails} details Additional details for this callback.
   */
  onMenuOpen: import_prop_types42.default.func,
  /**
   * Callback fired when the current page has changed.
   * @param {number} page Index of the page displayed on the Grid.
   * @param {GridCallbackDetails} details Additional details for this callback.
   */
  onPageChange: import_prop_types42.default.func,
  /**
   * Callback fired when the page size has changed.
   * @param {number} pageSize Size of the page displayed on the Grid.
   * @param {GridCallbackDetails} details Additional details for this callback.
   */
  onPageSizeChange: import_prop_types42.default.func,
  /**
   ...
   * @param {GridCallbackDetails} details Additional details for this callback.
   */
  onPreferencePanelClose: import_prop_types42.default.func,
  /**
   ...
   * @param {GridCallbackDetails} details Additional details for this callback.
   */
  onPreferencePanelOpen: import_prop_types42.default.func,
  /**
   * Callback called when `processRowUpdate` throws an error or rejects.
   * @param {any} error The error thrown.
   */
  onProcessRowUpdateError: import_prop_types42.default.func,
  /**
   ...
   * @param {GridCallbackDetails} details Additional details for this callback.
   */
  onResize: import_prop_types42.default.func,
  /**
   ...
   * @param {GridCallbackDetails} details Additional details for this callback.
   */
  onRowClick: import_prop_types42.default.func,
  /**
   ...
   * @param {GridCallbackDetails} details Additional details for this callback.
   */
  onRowDoubleClick: import_prop_types42.default.func,
  /**
   * Callback fired when the row changes are committed.
   * @param {GridRowId} id The row id.
   * @param {MuiEvent<MuiBaseEvent>} event The event that caused this prop to be called.
   */
  onRowEditCommit: import_prop_types42.default.func,
  /**
   * Callback fired when the row turns to edit mode.
   * @param {GridRowParams} params With all properties from [[GridRowParams]].
   * @param {MuiEvent<React.KeyboardEvent | React.MouseEvent>} event The event that caused this prop to be called.
   */
  onRowEditStart: import_prop_types42.default.func,
  /**
   * Callback fired when the row turns to view mode.
   * @param {GridRowParams} params With all properties from [[GridRowParams]].
   * @param {MuiEvent<MuiBaseEvent>} event The event that caused this prop to be called.
   */
  onRowEditStop: import_prop_types42.default.func,
  /**
   * Callback fired when the `rowModesModel` prop changes.
   * @param {GridRowModesModel} rowModesModel Object containig which rows are in "edit" mode.
   * @param {GridCallbackDetails} details Additional details for this callback.
   */
  onRowModesModelChange: import_prop_types42.default.func,
  /**
   * Callback fired when the selection state of one or multiple rows changes.
   * @param {GridSelectionModel} selectionModel With all the row ids [[GridSelectionModel]].
   * @param {GridCallbackDetails} details Additional details for this callback.
   */
  onSelectionModelChange: import_prop_types42.default.func,
  /**
   * Callback fired when the sort model changes before a column is sorted.
   * @param {GridSortModel} model With all properties from [[GridSortModel]].
   * @param {GridCallbackDetails} details Additional details for this callback.
   */
  onSortModelChange: import_prop_types42.default.func,
  /**
   ...
   * @ignore - do not document.
   */
  onStateChange: import_prop_types42.default.func,
  /**
   * The zero-based index of the current page.
   * @default 0
   */
  page: import_prop_types42.default.number,
  /**
   * Set the number of rows in one page.
   * If some of the rows have children (for instance in the tree data), this number represents the amount of top level rows wanted on each page.
   * @default 100
   */
  pageSize: chainPropTypes(import_prop_types42.default.number, (props) => {
   ...
   * @default "client"
   */
  paginationMode: import_prop_types42.default.oneOf(["client", "server"]),
  /**
   ...
   */
  processRowUpdate: import_prop_types42.default.func,
  /**
   * Number of extra rows to be rendered before/after the visible slice.
   * @default 3
   */
  rowBuffer: import_prop_types42.default.number,
  /**
   * Set the total number of rows, if it is different from the length of the value `rows` prop.
   * If some rows have children (for instance in the tree data), this number represents the amount of top level rows.
   */
  rowCount: import_prop_types42.default.number,
  /**
   * Set the height in pixel of a row in the grid.
   * @default 52
   */
  rowHeight: import_prop_types42.default.number,
  /**
   * Controls the modes of the rows.
   */
  rowModesModel: import_prop_types42.default.object,
  /**
   * Set of rows of type [[GridRowsProp]].
   */
  rows: import_prop_types42.default.arrayOf(import_prop_types42.default.object).isRequired,
  /**
   * Sets the type of space between rows added by `getRowSpacing`.
   * @default "margin"
   */
  rowSpacingType: import_prop_types42.default.oneOf(["border", "margin"]),
  /**
   * Select the pageSize dynamically using the component UI.
   * @default [25, 50, 100]
   */
  rowsPerPageOptions: import_prop_types42.default.arrayOf(import_prop_types42.default.number),
  /**
   * Number of rows from the `rowBuffer` that can be visible before a new slice is rendered.
   * @default 3
   */
  rowThreshold: import_prop_types42.default.number,
  /**
   * Override the height/width of the grid inner scrollbar.
   */
  scrollbarSize: import_prop_types42.default.number,
  /**
   * Set the selection model of the grid.
   */
  selectionModel: chainPropTypes(import_prop_types42.default.oneOfType([import_prop_types42.default.number, import_prop_types42.default.string, import_prop_types42.default.array]), (props) => {
   ...
   * @default false
   */
  showCellRightBorder: import_prop_types42.default.bool,
  /**
   * If `true`, the right border of the column headers are displayed.
   * @default false
   */
  showColumnRightBorder: import_prop_types42.default.bool,
  /**
   ...
   * @default "client"
   */
  sortingMode: import_prop_types42.default.oneOf(["client", "server"]),
  /**
   * The order of the sorting sequence.
   * @default ['asc', 'desc', null]
   */
  sortingOrder: import_prop_types42.default.arrayOf(import_prop_types42.default.oneOf(["asc", "desc"])),
  /**
   * Set the sort model of the grid.
   */
  sortModel: import_prop_types42.default.arrayOf(import_prop_types42.default.shape({
    field: import_prop_types42.default.string.isRequired,
    sort: import_prop_types42.default.oneOf(["asc", "desc"])
  })),
  /**
   * The system prop that allows defining system overrides as well as additional CSS styles.
   */
